...
$group_status = isset($group['status']) ? (string) $group['status'] : '';
// Security: show the cancel action only for owners on active groups (matches backend validation).
$can_cancel_group = $is_owner && $group_status === 'active';
...
$membership_role = isset($group['membership_role']) ? (string) $group['membership_role'] : ($is_owner ? 'owner' : 'member');
...
<div class="juntaplay-group-modal__detail">
    ...
    <div class="juntaplay-group-modal__body">
        <?php if ($price_highlight !== '' || $cta_label !== '' || $can_cancel_group) : ?>
            <div class="juntaplay-group-modal__cta">
                ...
                <?php if ($cta_label !== '') : ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($can_cancel_group) : ?>
                    <button type="button" class="juntaplay-button juntaplay-button--danger juntaplay-group-cancel" data-group-cancel-open>
                        <?php echo esc_html__('Cancelar Grupo', 'juntaplay'); ?>
                    </button>
                    <div class="juntaplay-modal juntaplay-modal--danger juntaplay-group-cancel__modal" data-group-cancel-modal hidden aria-hidden="true">
                        <div class="juntaplay-modal__overlay" data-group-cancel-close></div>
                        <div class="juntaplay-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="jp-group-cancel-title-<?php echo esc_attr((string) $group_id); ?>">
                            <button type="button" class="juntaplay-modal__close" data-group-cancel-close aria-label="<?php echo esc_attr__('Fechar', 'juntaplay'); ?>"></button>
                            <div class="juntaplay-modal__content">
                                <h3 id="jp-group-cancel-title-<?php echo esc_attr((string) $group_id); ?>"><?php echo esc_html__('Cancelar grupo', 'juntaplay'); ?></h3>
                                <p><?php echo esc_html__('Cancelar este grupo encerrará definitivamente o grupo. Os participantes manterão acesso até o fim do período já pago e seus calções serão devolvidos conforme as regras da plataforma. Esta ação não pode ser desfeita.', 'juntaplay'); ?></p>
                                <form class="juntaplay-group-cancel__form" method="post">
                                    ...
                                    ?>
                                    <div class="juntaplay-group-cancel__actions">
                                        <button type="submit" class="juntaplay-button juntaplay-button--danger">
                                            <?php echo esc_html__('Confirmar cancelamento', 'juntaplay'); ?>
                                        </button>
                                        <button type="button" class="juntaplay-button juntaplay-button--ghost" data-group-cancel-close>
