...
$can_edit         = isset($group['can_edit']) ? (bool) $group['can_edit'] : $is_owner;
$chat_link        = isset($group['chat_link']) ? (string) $group['chat_link'] : '';
$chat_label       = isset($group['chat_label']) ? (string) $group['chat_label'] : '';
...
<div class="juntaplay-group-modal__detail">
    ...
    <div class="juntaplay-group-modal__body">
        ...
        <?php if ($can_edit || $membership_status !== 'guest' || ($chat_link !== '' && $chat_label !== '')) : ?>
            <div class="juntaplay-group-modal__actions juntaplay-group-card__details-actions" data-group-modal-actions>
                ...
                <?php if ($chat_link !== '' && $chat_label !== '') : ?>
                    <a class="juntaplay-button juntaplay-button--primary juntaplay-button--glass" href="<?php echo esc_url($chat_link); ?>">
                        <?php echo esc_html($chat_label); ?>
                    </a>
                <?php else : ?>
                    <span data-group-chat-slot></span>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        ...
        <?php if ($complaint_url !== '' && $membership_status !== 'guest' && $membership_role_norm === 'member') : ?>
