...
$group_id         = isset($group['id']) ? (int) $group['id'] : (isset($group['group_id']) ? (int) $group['group_id'] : 0);
...
$is_member_role    = $membership_role !== '' && $membership_role !== 'guest';
...
<div class="juntaplay-group-modal__detail">
    ...
    <div class="juntaplay-group-modal__body">
        <?php if ($is_owner || $is_member_role) : ?>
            <?php
            $chat_params = [
            ...
            ?>
            <div class="juntaplay-group-card__message-row juntaplay-group-card__message-row--modal">
