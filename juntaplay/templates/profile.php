...
// Força a presença da Central de Mensagens dentro das seções do perfil,
// renderizando o shortcode de chat no layout padrão.
$profile_sections['juntaplay-chat'] = [
    'label' => __('Central de Mensagens', 'juntaplay'),
    'items' => [
        'juntaplay-chat' => [
            'type'        => 'custom',
            'label'       => __('Central de Mensagens', 'juntaplay'),
            'description' => __('Selecione um assinante para iniciar o chat.', 'juntaplay'),
            'content'     => do_shortcode('[juntaplay_chat]'),
        ],
    ],
];
