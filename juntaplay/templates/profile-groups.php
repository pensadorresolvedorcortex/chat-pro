...
<style>
    ...
    .juntaplay-group-card__cta-inline {
        display: inline-flex;
        align-items: center;
        gap: 10px;
        flex-wrap: wrap;
    ...
    .juntaplay-group-card__cta-pill {
        min-height: auto;
    ...
    .juntaplay-group-card__actions {
        display: flex;
        align-items: center;
        gap: 10px;
    }

    .juntaplay-group-card__toggle {
