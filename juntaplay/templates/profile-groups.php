                            ...
                            <?php endif; ?>
                                    ...
                                    <div class="juntaplay-group-card__footer">
                                        ...
                                        <div class="juntaplay-group-card__details-extended" hidden>
                                            ...
                                            <div class="juntaplay-group-card__role-banner">
                                                <span class="juntaplay-badge juntaplay-badge--muted">
                                                    <?php echo esc_html($is_owner ? __('Você administra este grupo', 'juntaplay') : __('Você é assinante deste grupo', 'juntaplay')); ?>
                                                </span>
                                                <a class="juntaplay-button juntaplay-button--ghost juntaplay-group-card__chat-btn" href="<?php echo esc_url($chat_link); ?>">
                                                    <span aria-hidden="true">💬</span>
                                                    <span>
                                                        <?php echo esc_html($is_owner ? __('Falar com assinantes', 'juntaplay') : __('Falar com o administrador', 'juntaplay')); ?>
                                                    </span>
                                                </a>
                                            </div>
