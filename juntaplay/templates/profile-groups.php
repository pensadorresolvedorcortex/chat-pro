...
$success_heading = isset($create_success['heading']) ? (string) $create_success['heading'] : __('Parabéns você Criou um Grupo.', 'juntaplay');
$success_body = isset($create_success['body']) ? (string) $create_success['body'] : __('Nossa equipe irá analizar e você será notificado.', 'juntaplay');
...
$success_redirect = home_url('/meus-grupos');
...
<div id="jp-profile-groups" class="juntaplay-groups" data-groups data-role-filter="all" data-status-filter="all" data-cover-placeholder="<?php echo esc_url($cover_placeholder); ?>">
            ...
            <div class="juntaplay-groups__create-modal">
                ...
                <div class="juntaplay-groups__create-body">
                    ...
                    <div class="juntaplay-form__actions">
                        <button type="submit" class="juntaplay-button juntaplay-button--primary"><?php echo esc_html__('Criar Grupo Agora', 'juntaplay'); ?></button>
                    </div>
                        </form>
                    </div>
                </div>
    ...
    <template id="jp-group-create-success-template" data-auto-open="<?php echo $should_open_success ? '1' : '0'; ?>">
        <div class="juntaplay-groups__success" data-group-create-success>
            <?php if ($success_image !== '') : ?>
                <figure class="juntaplay-groups__success-media">
                    <img src="<?php echo esc_url($success_image); ?>" alt="<?php esc_attr_e('Animação celebrando a criação do grupo', 'juntaplay'); ?>" loading="lazy" />
                </figure>
            <?php endif; ?>
            <div class="juntaplay-groups__success-content">
                <h3 class="juntaplay-groups__success-title"><?php echo esc_html($success_heading); ?></h3>
                <p class="juntaplay-groups__success-message"><?php echo esc_html($success_body); ?></p>
                <div class="juntaplay-groups__success-actions">
                    <button type="button" class="juntaplay-button juntaplay-button--primary" data-group-create-success-close data-modal-close>
                        <?php esc_html_e('Fechar', 'juntaplay'); ?>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="juntaplay-modal" data-group-create-success-modal hidden aria-hidden="true" data-success-redirect="<?php echo esc_url($success_redirect); ?>">
