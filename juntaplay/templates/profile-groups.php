...
$current_access_notes = isset($form_values['access_notes']) ? (string) $form_values['access_notes'] : '';
$current_access_observations = isset($form_values['access_observations']) ? (string) $form_values['access_observations'] : '';
...
$default_rule_items = [
    ...
    __('Não altere a senha do grupo', 'juntaplay'),
];
                    ...
                    <div class="juntaplay-groups__panel juntaplay-groups__form-wrapper<?php echo $initial_create_view === 'wizard' ? '' : ' is-hidden'; ?>" data-group-view="wizard">
                        ...
                        <form method="post" class="juntaplay-form juntaplay-groups__form" data-group-wizard>
                            ...
                            <div class="juntaplay-steps__header">
                                ...
                                <span class="juntaplay-steps__progress" data-step-progress>0%</span>
                            </div>
                                ...
                                <div class="juntaplay-form__group">
                                    <div class="juntaplay-rule-builder" data-rule-builder>
                                        <div class="juntaplay-rule-builder__header">
                                            ...
                                            <p class="juntaplay-form__help"><?php echo esc_html__('As três primeiras regras já vêm preenchidas, mas você pode ajustá-las. Todas ficam visíveis para os participantes.', 'juntaplay'); ?></p>
                                        </div>
                            ...
                            <section class="juntaplay-form__step is-hidden" data-group-step data-step-index="3">
                                <?php
                                $relationship_icons = [
                                    'cohabitants' => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 2 2 9.5V22h7v-6h6v6h7V9.5Zm0 2.3 6 4.29V20h-3v-6H9v6H6v-11Z" /></svg>',
                                    'family'      => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 12a3 3 0 1 0-3-3 3 3 0 0 0 3 3Zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4Zm7-11h-4v2h4v4h2V5a2 2 0 0 0-2-2Z" /></svg>',
                                    'friends'     => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 12a3.25 3.25 0 1 0-3.25-3.25A3.25 3.25 0 0 0 12 12Zm0 2.5c-3 0-9 1.5-9 4.5V21h18v-2c0-3-6-4.5-9-4.5Zm6.5-7A2.5 2.5 0 1 0 16 5a2.5 2.5 0 0 0 2.5 2.5Zm-1 1.75a5 5 0 0 1 2.87 2.53l.13.22V13h-4v-1.5Z" /></svg>',
                                    'coworkers'   => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 2 3 6v2h18V6ZM6 11v8h4v-3h4v3h4v-8Zm2 2h8v2H8Z" /></svg>',
                                ];
                                ...
                                $category_icons = [
                                    'video'     => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4 5h12a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H4a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3Zm6 3v8l5-4Z" /></svg>',
                                    'music'     => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M16 3 7 5v11.11A3.24 3.24 0 1 0 9.24 19V9.91L16 8.5v6.61A3.24 3.24 0 1 0 18.24 17V3Z" /></svg>',
                                    'education' => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 2 1 7l11 5 9-4.09V17h2V7ZM5 12v5l7 4 7-4v-5l-7 3Z" /></svg>',
                                    'reading'   => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M6 4h6v15H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Zm6 0h6a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3h-6Z" /></svg>',
                                    'office'    => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4 3h16v18H4Zm2 2v14h12V5Zm2 2h3v3H8Zm5 0h3v3h-3ZM8 12h3v3H8Zm5 0h3v3h-3Z" /></svg>',
                                    'games'     => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M6 7h12a4 4 0 0 1 3.87 5.06l-1.19 4.16A2.75 2.75 0 0 1 18 18H6a2.75 2.75 0 0 1-2.68-1.78L2.13 12A4 4 0 0 1 6 7Zm0 4.5v1h1.5V14h1v-1.5H10v-1H8.5V10h-1v1.5Zm9.75-.25a.75.75 0 1 0 .75.75.75.75 0 0 0-.75-.75Zm-2 2a.75.75 0 1 0 .75.75.75.75 0 0 0-.75-.75Zm1-3.5a.75.75 0 1 0 .75.75.75.75 0 0 0-.75-.75Z" /></svg>',
                                ];
                                ...
                                <div class="juntaplay-questionnaire">
                                    <div class="juntaplay-questionnaire__header">
                                        <div>
                                            <p class="juntaplay-questionnaire__eyebrow"><?php echo esc_html__('Passo 4', 'juntaplay'); ?></p>
                                        ...
                                        <div class="juntaplay-question" data-choice-group>
                                            ...
                                            <div class="juntaplay-choice-grid juntaplay-choice-grid--compact">
                                                <?php foreach ($support_options as $support_value => $support_label) :
                                                    ...
                                                    $icon_markup = '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4 4h16v12H5.17L4 17.17V4Zm2 2v8h12V6Zm3 12h5v2H9Z" /></svg>';
                                                ?>
                                        ...
                                        <div class="juntaplay-question" data-choice-group data-choice-sync="[data-access-timing]">
                                            ...
                                            <div class="juntaplay-choice-grid juntaplay-choice-grid--compact">
                                                ...
                                                foreach ($timing_options as $timing_value => $timing_label) :
                                                    ...
                                                    $icon_markup = $timing_value === 'immediate'
                                                        ...
                                                        : '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M6 3a2 2 0 0 0-2 2v12a4 4 0 0 0 4 4h8a2 2 0 0 0 2-2V9.5L13.5 3Zm7 1.5L17.5 9H13Zm-6 0h4v6h6V19a.5.5 0 0 1-.5.5h-8A2.5 2.5 0 0 1 5 17V5.5A.5.5 0 0 1 5.5 4.5Z" /></svg>';
                                                ?>
                                        ...
                                        <div class="juntaplay-question" data-choice-group>
                                            ...
                                            <div class="juntaplay-choice-grid juntaplay-choice-grid--compact">
                                                <?php foreach ($access_options as $access_value => $access_label) :
                                                    ...
                                                    $icon_markup = '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M20 4H4a2 2 0 0 0-2 2v9h2V6h16v8h2V6a2 2 0 0 0-2-2Zm-1 10-4 4H9l-4-4Zm-8 4h2v3h-2Z" /></svg>';
                                                ?>
                            ...
                            <section class="juntaplay-form__step is-hidden<?php echo $current_access_timing === 'immediate' ? '' : ' is-disabled'; ?>" data-group-step data-step-index="4" data-access-immediate>
                                <div class="juntaplay-stepsection">
                                    <div class="juntaplay-stepsection__header">
                                        <span class="juntaplay-stepsection__step" aria-hidden="true">4</span>
                                        <div>
                                    ...
                                    <div class="juntaplay-stepflow">
                                        <div class="juntaplay-stepflow__row">
                                            <article class="juntaplay-stepcard juntaplay-stepcard--full juntaplay-stepcard--stage juntaplay-access-fields">
                                                <span class="juntaplay-stepcard__stage">Etapa 5</span>
                                            ...
                                            <article class="juntaplay-stepcard juntaplay-stepcard--full juntaplay-stepcard--stage">
                                                <span class="juntaplay-stepcard__stage">Etapa 6</span>
                                                <div class="juntaplay-stepcard__icon" aria-hidden="true">
                                                    <svg viewBox="0 0 24 24" role="presentation" focusable="false">
                                                        <path fill="currentColor" d="M3 5h18v2H3Zm0 12h18v2H3Zm0-6h18v2H3Z" />
                                                    </svg>
                                                </div>
                                                <div class="juntaplay-stepcard__body">
                                                    <h4><?php echo esc_html__('Observações e notas', 'juntaplay'); ?></h4>
                                                    <div class="juntaplay-form__grid">
                                                        <div class="juntaplay-form__group">
                                                            <label for="jp-group-access-notes"><?php echo esc_html__('Observações para os participantes', 'juntaplay'); ?></label>
                                                            <textarea
                                                                id="jp-group-access-notes"
                                                                name="jp_profile_group_access_notes"
                                                                class="juntaplay-form__input"
                                                                rows="3"
                                                                placeholder="<?php echo esc_attr__('Ex.: Atualizamos a senha a cada 30 dias. Confira o e-mail para novos dados.', 'juntaplay'); ?>"
                                                            ><?php echo esc_textarea($current_access_notes); ?></textarea>
                                                        </div>
                                                        <div class="juntaplay-form__group">
                                                            <label for="jp-group-access-observations"><?php echo esc_html__('Notas internas ou lembretes', 'juntaplay'); ?></label>
                                                            <textarea
                                                                id="jp-group-access-observations"
                                                                name="jp_profile_group_access_observations"
                                                                class="juntaplay-form__input"
                                                                rows="3"
                                                                placeholder="<?php echo esc_attr__('Essas notas ajudam você a lembrar combinações, datas de troca ou suporte adicional.', 'juntaplay'); ?>"
                                                            ><?php echo esc_textarea($current_access_observations); ?></textarea>
                                                            <p class="juntaplay-form__help"><?php echo esc_html__('Somente administradores do grupo podem ver este campo.', 'juntaplay'); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
