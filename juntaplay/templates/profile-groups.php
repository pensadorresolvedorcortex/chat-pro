...
$chat_context        = isset($group_context['chat']) && is_array($group_context['chat']) ? $group_context['chat'] : [];
$chat_subscribers    = isset($chat_context['subscribers']) && is_array($chat_context['subscribers']) ? $chat_context['subscribers'] : [];
$chat_groups         = isset($chat_context['groups']) && is_array($chat_context['groups']) ? $chat_context['groups'] : [];
$chat_recipient      = isset($chat_context['recipient']) && is_array($chat_context['recipient']) ? $chat_context['recipient'] : [];
$chat_admin          = isset($chat_context['admin']) && is_array($chat_context['admin']) ? $chat_context['admin'] : [];
$chat_recipient_name = isset($chat_recipient['name']) ? (string) $chat_recipient['name'] : __('Assinante', 'juntaplay');
$chat_recipient_role = isset($chat_recipient['role']) ? (string) $chat_recipient['role'] : __('Assinante', 'juntaplay');
$chat_recipient_group = isset($chat_recipient['group']) ? (string) $chat_recipient['group'] : __('Grupo', 'juntaplay');
$chat_recipient_avatar = isset($chat_recipient['avatar']) ? (string) $chat_recipient['avatar'] : '';
$chat_admin_name     = isset($chat_admin['name']) ? (string) $chat_admin['name'] : __('Administrador', 'juntaplay');
$chat_admin_avatar   = isset($chat_admin['avatar']) ? (string) $chat_admin['avatar'] : '';
$chat_placeholder    = isset($chat_context['placeholder']) ? (string) $chat_context['placeholder'] : __('Digite sua mensagem...', 'juntaplay');
...
<div class="juntaplay-chat-shell"<?php echo $is_chat_section ? '' : ' hidden'; ?> data-juntaplay-chat>
