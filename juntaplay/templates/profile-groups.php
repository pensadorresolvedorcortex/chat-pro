        ...
        (() => {
            ...
            const fetchContext = async (groupId = 0) => {
                ...
                if (Array.isArray(normalizedGroups) && normalizedGroups.length) {
                    ...
                    renderGroupList();
                    emitNotifications(state.groups);
        ...
        foreach ($all_groups as $group) :
            if (!is_array($group)) {
                continue;
                    ...
                    if ($role_label !== '') {
                        $admin_keyword = 'administra';
                        if (stripos($role_label, $admin_keyword) === false) {
                            ...
                            <?php endif; ?>
                                    ...
                                    <div class="juntaplay-group-card__footer">
                                        <div class="juntaplay-group-card__cta-inline">
                                            <a
                                                class="juntaplay-button juntaplay-button--ghost juntaplay-button--glass juntaplay-group-card__cta-pill"
                                                style="min-height:auto;padding:0.55rem 0.9rem;border-radius:14px;background:linear-gradient(145deg, rgba(255,255,255,0.18), rgba(255,255,255,0.08));border:1px solid rgba(255,255,255,0.32);box-shadow:0 10px 26px rgba(15,23,42,0.14);"
                                                href="#"
                                                data-jp-group-open
                                                data-group-id="<?php echo esc_attr((string) $group_id); ?>"
                                                <?php echo $cta_disabled ? ' aria-disabled="true"' : ''; ?>
                                            >
                                        ...
                                        <div class="juntaplay-group-card__actions juntaplay-group-card__actions--primary">
                                            <button type="button" class="juntaplay-button juntaplay-button--primary juntaplay-button--glass juntaplay-group-card__toggle" style="background:linear-gradient(135deg, rgba(94,234,212,0.22), rgba(59,130,246,0.2));border:1px solid rgba(59,130,246,0.35);box-shadow:0 14px 32px rgba(59,130,246,0.25);color:#ecf5ff;" aria-expanded="false">
                                        ...
                                        <div class="juntaplay-group-card__details-extended" hidden>
                                            ...
                                            <div class="juntaplay-group-card__details-actions">
                                                ...
                                                $is_admin = $owner_id === $current_user_id
                                                ...
                                                if ($membership_status !== 'guest' && $chat_target_url !== '') {
                                                    if ($is_admin) {
                                                        $admin_chat_link = add_query_arg(
                                                            [
                                                                'group_id'    => $group_id,
                                                                'admin_id'    => $owner_id ?: $current_user_id,
                                                                'thread_id'   => isset($group['thread_id']) ? (int) $group['thread_id'] : '',
                                                                'sender_id'   => $current_user_id,
                                                            ],
                                                            $chat_target_url
                                                        );
                                                    } elseif ($owner_id !== $current_user_id && $owner_id > 0) {
                                                        $chat_link = add_query_arg(
                                                            [
                                                                'group_id' => $group_id,
                                                                'admin_id' => $owner_id,
                                                ...
                                                <?php if ($admin_chat_link !== '') : ?>
                                                    <a class="juntaplay-button juntaplay-button--primary juntaplay-button--glass" href="<?php echo esc_url($admin_chat_link); ?>"><?php esc_html_e('Fale com Assinante', 'juntaplay'); ?></a>
                                                <?php elseif ($chat_link !== '') : ?>
                                                    <a class="juntaplay-button juntaplay-button--primary juntaplay-button--glass" href="<?php echo esc_url($chat_link); ?>"><?php esc_html_e('Fale com Administrador', 'juntaplay'); ?></a>
                                                <?php endif; ?>
                                            </div>
