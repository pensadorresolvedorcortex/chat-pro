...
<style>
    ...
    .juntaplay-service-card__link {
        gap: 6px;
    }

    .juntaplay-service-card__title {
        font-size: 0.96rem;
    }

    .juntaplay-service-card__meta {
        gap: 4px;
    }
    ...
    .juntaplay-group-card__edit.juntaplay-group-card__edit--inline {
