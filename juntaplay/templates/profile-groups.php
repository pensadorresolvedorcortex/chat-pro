...
<div class="juntaplay-groups" data-groups data-role-filter="all" data-status-filter="all">
    ...
    <div class="juntaplay-groups__list">
        <?php if ($all_groups) : ?>
            <div class="juntaplay-groups__table-wrapper" data-group-list>
                <div class="juntaplay-groups__table-scroll">
                    <table class="juntaplay-groups-table">
                        <thead>
                            <tr>
                                <th scope="col"><?php esc_html_e('Grupo', 'juntaplay'); ?></th>
                                <th scope="col"><?php esc_html_e('Função', 'juntaplay'); ?></th>
                                <th scope="col"><?php esc_html_e('Vagas', 'juntaplay'); ?></th>
                                <th scope="col"><?php esc_html_e('Valor', 'juntaplay'); ?></th>
                                <th scope="col"><?php esc_html_e('Status', 'juntaplay'); ?></th>
                                <th scope="col" class="juntaplay-groups-table__actions-header"><?php esc_html_e('Ações', 'juntaplay'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($all_groups as $group) :
                                ...
                                $group_title_display = $group_title_full;
                                if ($price_highlight === '' && $member_display !== '') {
                                    $price_highlight = $member_display;
                                }
                                if (function_exists('mb_strlen') && function_exists('mb_substr')) {
                                    if (mb_strlen($group_title_display) > 40) {
                                        $group_title_display = rtrim(mb_substr($group_title_display, 0, 37)) . '…';
                                    }
                                } elseif (strlen($group_title_display) > 40) {
                                    $group_title_display = rtrim(substr($group_title_display, 0, 37)) . '…';
                                }
                                ...
                                ob_start();
                                ?>
                                <article class="juntaplay-group-card juntaplay-group-card--profile" data-group-role="<?php echo esc_attr($group_role); ?>" data-group-status="<?php echo esc_attr($status); ?>">
                                ...
                                <?php
                                $detail_markup = ob_get_clean();
                                $group_detail_id = $group_id > 0 ? 'jp-group-detail-' . $group_id : 'jp-group-detail-' . uniqid();
                                $group_detail_templates[] = [
                                    'id'   => $group_detail_id,
                                    'html' => $detail_markup,
                                ];

                                $availability_display = $availability_label !== '' ? $availability_label : $slots_summary;
                                if ($availability_display === '' && $slots_total_label !== '') {
                                    $availability_display = $slots_total_label;
                                }
                                $price_display_short = $price_highlight !== '' ? $price_highlight : ($member_display !== '' ? $member_display : '—');
                                $status_badge_class = 'juntaplay-badge';
                                if ($status_tone !== '') {
                                    $status_badge_class .= ' juntaplay-badge--' . sanitize_html_class($status_tone);
                                }
                                $role_badge_class = 'juntaplay-badge';
                                if ($role_tone !== '') {
                                    $role_badge_class .= ' juntaplay-badge--' . sanitize_html_class($role_tone);
                                }
                                $availability_badge_class = 'juntaplay-badge';
                                if ($availability_tone !== '') {
                                    $availability_badge_class .= ' juntaplay-badge--' . sanitize_html_class($availability_tone);
                                }
                            ?>
                                <tr class="juntaplay-groups-table__row" data-group-item data-group-role="<?php echo esc_attr($group_role); ?>" data-group-status="<?php echo esc_attr($status); ?>">
                                    <td class="juntaplay-groups-table__cell juntaplay-groups-table__cell--name" data-label="<?php echo esc_attr__('Grupo', 'juntaplay'); ?>">
                                        <div class="juntaplay-groups-table__name">
                                            <strong><?php echo esc_html($group_title_display); ?></strong>
                                            <?php if ($category_label !== '') : ?>
                                                <span class="juntaplay-groups-table__category"><?php echo esc_html($category_label); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="juntaplay-groups-table__cell" data-label="<?php echo esc_attr__('Função', 'juntaplay'); ?>">
                                        <?php if ($role_label !== '') : ?>
                                            <span class="<?php echo esc_attr($role_badge_class); ?>"><?php echo esc_html($role_label); ?></span>
                                        <?php else : ?>
                                            <span class="juntaplay-groups-table__muted"><?php esc_html_e('Participante', 'juntaplay'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="juntaplay-groups-table__cell" data-label="<?php echo esc_attr__('Vagas', 'juntaplay'); ?>">
                                        <?php if ($availability_display !== '') : ?>
                                            <span class="<?php echo esc_attr($availability_badge_class); ?>"><?php echo esc_html($availability_display); ?></span>
                                        <?php else : ?>
                                            <span class="juntaplay-groups-table__muted"><?php esc_html_e('Informação indisponível', 'juntaplay'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="juntaplay-groups-table__cell" data-label="<?php echo esc_attr__('Valor', 'juntaplay'); ?>">
                                        <span class="juntaplay-groups-table__price"><?php echo esc_html($price_display_short); ?></span>
                                    </td>
                                    <td class="juntaplay-groups-table__cell" data-label="<?php echo esc_attr__('Status', 'juntaplay'); ?>">
                                        <?php if ($status_label !== '') : ?>
                                            <span class="<?php echo esc_attr($status_badge_class); ?>"><?php echo esc_html($status_label); ?></span>
                                        <?php else : ?>
                                            <span class="juntaplay-groups-table__muted"><?php esc_html_e('Sem status', 'juntaplay'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="juntaplay-groups-table__cell juntaplay-groups-table__cell--actions" data-label="<?php echo esc_attr__('Ações', 'juntaplay'); ?>">
                                        <button type="button" class="juntaplay-button juntaplay-button--ghost juntaplay-groups-table__action" data-group-detail-trigger data-detail-target="#<?php echo esc_attr($group_detail_id); ?>">
    ...
    <?php if ($group_detail_templates) : ?>
        <?php foreach ($group_detail_templates as $template) :
            if (!isset($template['id'], $template['html'])) {
                continue;
            }
    ...
    <section class="juntaplay-groups__create-card">
        ...
        <div class="juntaplay-groups__create-launch">
            ...
            <div class="juntaplay-groups__create-actions">
                <button type="button" class="juntaplay-button juntaplay-button--primary" data-group-create-trigger>
    ...
    <template id="jp-group-create-template" data-auto-open="<?php echo !empty($form_errors) ? '1' : '0'; ?>">
    ...
    <div class="juntaplay-modal" data-group-modal hidden aria-hidden="true">
