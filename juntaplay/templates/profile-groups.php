    ...
    <div class="juntaplay-groups__list" data-group-list>
        <?php if ($all_groups) : ?>
            ...
            ?>
                ...
                ?>
                <article class="juntaplay-group-card juntaplay-group-card--profile" data-group-item data-group-role="<?php echo esc_attr($group_role); ?>" data-group-status="<?php echo esc_attr($status); ?>">
                    ...
                    <div class="juntaplay-group-card__body">
                        <header class="juntaplay-group-card__header">
                            <div class="juntaplay-group-card__headline">
                                <h3 class="juntaplay-group-card__title" title="<?php echo esc_attr($group_title_full); ?>"><?php echo esc_html($group_title_display); ?></h3>
                                <?php if ($role_label !== '') : ?>
