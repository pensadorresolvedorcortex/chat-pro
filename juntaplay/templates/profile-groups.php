                            ...
                            <section class="juntaplay-form__step" data-group-step data-step-index="0">
                                ...
                                <div class="juntaplay-form__grid">
                                    <div class="juntaplay-form__group">
                                        ...
                                        <select id="jp-group-category" name="jp_profile_group_category" class="juntaplay-form__input" data-group-share-watch data-group-pool-category>
                            ...
                            <section class="juntaplay-form__step is-hidden" data-group-step data-step-index="3">
                                <div class="juntaplay-stepsection">
                                    <div class="juntaplay-stepsection__header">
                                        <span class="juntaplay-stepsection__step" aria-hidden="true">3</span>
                                        <div>
                                            <h3 class="juntaplay-stepsection__title"><?php echo esc_html__('Suporte e acesso', 'juntaplay'); ?></h3>
                                            <p class="juntaplay-stepsection__subtitle"><?php echo esc_html__('Preencha cada cartão para repetir fielmente o fluxo aprovado.', 'juntaplay'); ?></p>
                                        </div>
                                    </div>

                                    <div class="juntaplay-stepflow">
                                        <div class="juntaplay-stepflow__row">
                                            <article class="juntaplay-stepcard juntaplay-stepcard--stage">
                                                <span class="juntaplay-stepcard__stage">Etapa 1</span>
                                                <div class="juntaplay-stepcard__icon" aria-hidden="true">
                                                    <svg viewBox="0 0 24 24" role="presentation" focusable="false">
                                                        <path fill="currentColor" d="M12 3a9 9 0 0 0-9 9v3a3 3 0 0 0 3 3h2v-6H6v-3a6 6 0 1 1 12 0v3h-2v6h2a3 3 0 0 0 3-3v-3a9 9 0 0 0-9-9Zm-3 12h6v3H9Z" />
                                                    </svg>
                                                </div>
                                                <div class="juntaplay-stepcard__body">
                                                    <h4><?php echo esc_html__('Suporte a Membros', 'juntaplay'); ?></h4>
                                                    <p class="juntaplay-form__help"><?php echo esc_html__('Informe o canal de suporte principal que os participantes usarão.', 'juntaplay'); ?></p>
                                                    <input
                                                        type="text"
                                                        id="jp-group-support"
                                            ...
                                            <article class="juntaplay-stepcard juntaplay-stepcard--stage">
                                                <span class="juntaplay-stepcard__stage">Etapa 2</span>
                                                <div class="juntaplay-stepcard__icon" aria-hidden="true">
                                                    <svg viewBox="0 0 24 24" role="presentation" focusable="false">
                                                        <path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8Zm1-13h-2v6h6v-2h-4Z" />
                                                    </svg>
                                                </div>
                                                <div class="juntaplay-stepcard__body">
                                                    <h4><?php echo esc_html__('Quando os participantes recebem o acesso?', 'juntaplay'); ?></h4>
                                                    <p class="juntaplay-form__help"><?php echo esc_html__('Escolha Imediatamente para abrir o formulário de acesso e publicar sem fila quando for pré-aprovado.', 'juntaplay'); ?></p>
                                                    <select
                                                        ...
                                                        required
                                                    >
                                                        <option value="immediate" <?php selected($current_access_timing, 'immediate'); ?>><?php echo esc_html__('Imediatamente', 'juntaplay'); ?></option>
                                                        <option value="scheduled" <?php selected($current_access_timing, 'scheduled'); ?>><?php echo esc_html__('Após liberação manual', 'juntaplay'); ?></option>
                                                    </select>
                                                </div>
                                            </article>
                                        </div>
                                        ...
                                        <div class="juntaplay-stepflow__row">
                                            <article class="juntaplay-stepcard juntaplay-stepcard--stage">
                                                <span class="juntaplay-stepcard__stage">Etapa 3</span>
                                                <div class="juntaplay-stepcard__icon" aria-hidden="true">
                                                    <svg viewBox="0 0 24 24" role="presentation" focusable="false">
                                                        <path fill="currentColor" d="M21 7.5a2.5 2.5 0 0 0-4.27-1.77l-3.46 3.46-.8-.8 1.06-1.06-2.12-2.12L8.4 6.71a4.06 4.06 0 0 0-.64 4.87l-4.1 4.1a2.5 2.5 0 1 0 3.54 3.54l4.1-4.1a4.06 4.06 0 0 0 4.87-.64l1.5-1.5-2.12-2.12 1.06-1.06 1.41 1.42L21 9.5Zm-17 10a.5.5 0 0 1-.35-.85l4.34-4.34 1.06 1.06L4.7 17.7a.5.5 0 0 1-.35.15Z" />
                                                    </svg>
                                                </div>
                                                <div class="juntaplay-stepcard__body">
                                                    <h4><?php echo esc_html__('Forma de acesso enviada', 'juntaplay'); ?></h4>
                                                    <p class="juntaplay-form__help"><?php echo esc_html__('Descreva como os participantes recebem o acesso ao serviço.', 'juntaplay'); ?></p>
                                                    <input
                                                        type="text"
                                                        id="jp-group-access"
                                            ...
                                            <article class="juntaplay-stepcard juntaplay-stepcard--stage">
                                                <span class="juntaplay-stepcard__stage">Etapa 4</span>
                                                <div class="juntaplay-stepcard__icon" aria-hidden="true">
                                                    <svg viewBox="0 0 24 24" role="presentation" focusable="false">
                                                        <path fill="currentColor" d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4Zm7-5h-2V6h-2V4h2V2h2v2h2v2h-2Z" />
                                                    </svg>
                                                </div>
                                                <div class="juntaplay-stepcard__body">
                                                    <h4><?php echo esc_html__('Relação com o administrador', 'juntaplay'); ?></h4>
                                                    <div class="juntaplay-relationship" role="radiogroup" aria-labelledby="jp-group-relationship">
                                                        <?php foreach ($relationship_options as $relationship_key => $relationship_label) :
                                                            $rel_id = 'jp-relationship-' . $relationship_key;
                                                        ?>
                                                            <label class="juntaplay-relationship__option" for="<?php echo esc_attr($rel_id); ?>">
                                                                <input
                                                                    type="radio"
                                                                    id="<?php echo esc_attr($rel_id); ?>"
                                                                    name="jp_profile_group_relationship"
                                                                    value="<?php echo esc_attr((string) $relationship_key); ?>"
                                                                    <?php checked($current_relationship, (string) $relationship_key); ?>
                                                                    required
                                                                />
                                                                <span><?php echo esc_html((string) $relationship_label); ?></span>
                                                            </label>
                                                        <?php endforeach; ?>
                                                    </div>
                                                </div>
