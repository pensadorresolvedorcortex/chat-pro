        ...
        foreach ($all_groups as $group) :
            if (!is_array($group)) {
                continue;
                    ...
                    if ($role_label !== '') {
                        $admin_pill_label = __('Você administra este grupo', 'juntaplay');
                        if ($role_label !== $admin_pill_label) {
                            ...
                            <?php endif; ?>
                                    ...
                                    <div class="juntaplay-group-card__footer">
                                        ...
                                        <div class="juntaplay-group-card__actions juntaplay-group-card__actions--primary">
                                            <button type="button" class="juntaplay-button juntaplay-button--primary juntaplay-button--glass juntaplay-group-card__toggle" aria-expanded="false">
