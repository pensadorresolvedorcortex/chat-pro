                            ...
                            <?php if ($pool_featured) : ?>
                                <ul class="juntaplay-service-list">
                                    <?php foreach ($pool_featured as $pool) :
                                        ...
                                        $pool_thumbnail = isset($pool['thumbnail']) ? (string) $pool['thumbnail'] : '';
                        ...
                        <form method="post" class="juntaplay-form juntaplay-groups__form" data-group-wizard>
                            ...
                            <section class="juntaplay-form__step is-hidden" data-group-step data-step-index="3">
                                <div class="juntaplay-form__grid">
                                    ...
                                    <div class="juntaplay-form__group">
                                        <label for="jp-group-delivery"><?php echo esc_html__('Quando os participantes recebem o acesso?', 'juntaplay'); ?></label>
                                        <select
                                ...
                                <div class="juntaplay-form__grid">
                                    ...
                                    <div class="juntaplay-form__group">
                                        <label for="jp-group-relationship"><?php echo esc_html__('Relação com o administrador', 'juntaplay'); ?></label>
                                ...
                                <div class="juntaplay-form__group juntaplay-access-fields<?php echo $current_access_timing === 'immediate' ? '' : ' is-hidden'; ?>" data-access-immediate>
                                    <div class="juntaplay-form__grid">
                                        <div class="juntaplay-form__group">
