...
<div id="jp-profile-groups" class="juntaplay-groups" data-groups data-role-filter="all" data-status-filter="all" data-cover-placeholder="<?php echo esc_url($cover_placeholder); ?>">
    ...
    <section class="juntaplay-groups__create-card juntaplay-create-hero">
        ...
        <div class="juntaplay-create-hero__glass">
            <div class="juntaplay-create-hero__intro">
                <p class="juntaplay-eyebrow"><?php echo esc_html__('Experiência redesenhada', 'juntaplay'); ?></p>
                <h3><?php echo esc_html__('Crie um grupo com estética premium', 'juntaplay'); ?></h3>
                <p class="juntaplay-create-hero__lead"><?php echo esc_html__('Interface hipervisual com fluidez, transições suaves e feedback instantâneo em cada etapa.', 'juntaplay'); ?></p>
                <div class="juntaplay-create-hero__tags">
                    <span><?php echo esc_html__('Glassmorfismo', 'juntaplay'); ?></span>
                    <span><?php echo esc_html__('100% responsivo', 'juntaplay'); ?></span>
                    <span><?php echo esc_html__('Fluxo guiado', 'juntaplay'); ?></span>
                </div>
            </div>
            ...
            <div class="juntaplay-create-hero__cta">
                ...
                <p class="juntaplay-create-hero__hint"><?php echo esc_html__('Acesse o fluxo completo em poucos segundos, com indicações claras e animações leves.', 'juntaplay'); ?></p>
            </div>
        </div>

        <div class="juntaplay-create-hero__grid">
            <article class="juntaplay-create-hero__card">
                <div class="juntaplay-create-hero__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M19 3H5a2 2 0 0 0-2 2v11a4 4 0 0 0 4 4h10a4 4 0 0 0 4-4V5a2 2 0 0 0-2-2Zm0 13a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6h14Z"/><path fill="currentColor" d="M7 8h10v2H7Zm0 4h6v2H7Z"/></svg>
                </div>
                <div class="juntaplay-create-hero__text">
                    <p class="juntaplay-create-hero__label"><?php echo esc_html__('Painéis contextuais', 'juntaplay'); ?></p>
                    <p class="juntaplay-create-hero__description"><?php echo esc_html__('Cards cintilantes guiam cada decisão com microcópias claras.', 'juntaplay'); ?></p>
                </div>
            </article>
            <article class="juntaplay-create-hero__card">
                <div class="juntaplay-create-hero__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="m20.06 4.94-1.41 1.41A6.5 6.5 0 0 0 9.9 9.1l-4.6 4.6a2.5 2.5 0 0 0 3.54 3.53l4.59-4.58a6.5 6.5 0 0 0 2.75-8.74L17.59 3.5ZM7.75 17.66a1 1 0 0 1-1.42-1.4l1.75-1.76 1.42 1.42ZM14.3 11.1l-3.16 3.16-1.42-1.41 3.17-3.17a4.5 4.5 0 0 1 4.38-1.18l-1.77 1.77a2.5 2.5 0 0 0-1.2 2.83ZM18.5 8.7l-1.2 1.2-1.42-1.41 1.2-1.21a4.47 4.47 0 0 1 1.42 1.42Z"/></svg>
                </div>
                <div class="juntaplay-create-hero__text">
                    <p class="juntaplay-create-hero__label"><?php echo esc_html__('Feedback imediato', 'juntaplay'); ?></p>
                    <p class="juntaplay-create-hero__description"><?php echo esc_html__('Indicadores luminosos sinalizam etapas ativas e status de envio.', 'juntaplay'); ?></p>
                </div>
            </article>
            <article class="juntaplay-create-hero__card">
                <div class="juntaplay-create-hero__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 2A10 10 0 1 0 22 12 10 10 0 0 0 12 2Zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8Zm-1-5.41-2.3-2.3-1.4 1.42L11 17.41l6.71-6.7-1.42-1.42Z"/></svg>
                </div>
                <div class="juntaplay-create-hero__text">
                    <p class="juntaplay-create-hero__label"><?php echo esc_html__('Pronto para mobile', 'juntaplay'); ?></p>
                    <p class="juntaplay-create-hero__description"><?php echo esc_html__('Componentes fluidos, com espaçamento generoso e gestos naturais.', 'juntaplay'); ?></p>
                </div>
            </article>
        </div>
    </section>
            ...
            >
                ...
                <header class="juntaplay-groups__create-header juntaplay-create-modal__header">
                    <div class="juntaplay-groups__create-heading">
                        <p class="juntaplay-eyebrow"><?php echo esc_html__('Fluxo imersivo', 'juntaplay'); ?></p>
                        <h3><?php echo esc_html__('Criar novo grupo', 'juntaplay'); ?></h3>
                        <p class="juntaplay-create-modal__lead"><?php echo esc_html__('Uma jornada em camadas translúcidas, com destaque para ações essenciais e feedback imediato.', 'juntaplay'); ?></p>
                    </div>
                    <div class="juntaplay-create-modal__meta">
                        <span class="juntaplay-create-modal__pill"><?php echo esc_html__('4 etapas guiadas', 'juntaplay'); ?></span>
                        <span class="juntaplay-create-modal__pill"><?php echo esc_html__('Visual modernizado', 'juntaplay'); ?></span>
                        <span class="juntaplay-create-modal__pill"><?php echo esc_html__('Aprovação rápida', 'juntaplay'); ?></span>
                    </div>
                </header>

                <div class="juntaplay-groups__create-body juntaplay-create-body">
                    <aside class="juntaplay-create-aside">
                        <div class="juntaplay-create-aside__card">
                            <div>
                                <p class="juntaplay-create-aside__eyebrow"><?php echo esc_html__('Em destaque', 'juntaplay'); ?></p>
                                <h4><?php echo esc_html__('Tudo fica claro em cada passo', 'juntaplay'); ?></h4>
                                <p><?php echo esc_html__('Microcópias curtas, cores acesas e visual translúcido criam um caminho intuitivo para concluir o envio.', 'juntaplay'); ?></p>
                            </div>
                            <div class="juntaplay-create-aside__checks">
                                <span><?php echo esc_html__('Indicadores de progresso', 'juntaplay'); ?></span>
                                <span><?php echo esc_html__('Layout pronto para toque', 'juntaplay'); ?></span>
                                <span><?php echo esc_html__('Campos com dicas visuais', 'juntaplay'); ?></span>
                            </div>
                        </div>
                        <div class="juntaplay-create-aside__card juntaplay-create-aside__card--secondary">
                            <p class="juntaplay-create-aside__eyebrow"><?php echo esc_html__('Velocidade', 'juntaplay'); ?></p>
                            <h5><?php echo esc_html__('Preencha e envie sem fricção', 'juntaplay'); ?></h5>
                            <p><?php echo esc_html__('A interface reage a cada clique com brilho sutil, mantendo o foco no que importa.', 'juntaplay'); ?></p>
                        </div>
                    </aside>
