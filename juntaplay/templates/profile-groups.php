                    ...
                    <div class="juntaplay-groups__panel juntaplay-groups__form-wrapper<?php echo $initial_create_view === 'wizard' ? '' : ' is-hidden'; ?>" data-group-view="wizard">
                        ...
                        <form method="post" class="juntaplay-form juntaplay-groups__form" data-group-wizard>
                            ...
                            <section class="juntaplay-form__step is-hidden" data-group-step data-step-index="3">
                                <?php
                                $relationship_icons = [
                                    'cohabitants' => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 3.25 3.5 10v9.25a1 1 0 0 0 1 1H10v-5.25A2.25 2.25 0 0 1 12.25 12H13a2.25 2.25 0 0 1 2.25 2.25v5.25H20.5V10Z" opacity=".9" /><path fill="currentColor" d="M10 11.5a1.75 1.75 0 1 1 1.75-1.75A1.75 1.75 0 0 1 10 11.5Zm7 0a1.75 1.75 0 1 1 1.75-1.75A1.75 1.75 0 0 1 17 11.5Z" opacity=".55" /></svg>',
                                    'family'      => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M7.5 11a2 2 0 1 1 2-2 2 2 0 0 1-2 2Zm9 0a2 2 0 1 1 2-2 2 2 0 0 1-2 2Z" /><path fill="currentColor" d="M6 17.5A2.5 2.5 0 0 1 8.5 15h.5a1.75 1.75 0 0 1 1.4.7l1.1 1.4 1.1-1.4a1.75 1.75 0 0 1 1.4-.7h.5A2.5 2.5 0 0 1 17 17.5V20H6Z" opacity=".9" /><path fill="currentColor" d="M12 11.75a1.5 1.5 0 1 1-1.5 1.5 1.5 1.5 0 0 1 1.5-1.5Z" opacity=".6" /></svg>',
                                    'friends'     => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4.5 6.75A3.75 3.75 0 0 1 8.25 3h7.5A3.75 3.75 0 0 1 19.5 6.75v5.5A3.75 3.75 0 0 1 15.75 16h-.77l-2.06 1.94a.75.75 0 0 1-1.27-.53V16H8.25A3.75 3.75 0 0 1 4.5 12.25Z" opacity=".9" /><path fill="currentColor" d="M9 9.25a.75.75 0 1 0-.75-.75.75.75 0 0 0 .75.75Zm6 0a.75.75 0 1 0-.75-.75.75.75 0 0 0 .75.75Zm-5.5 2.25A2 2 0 0 0 12 12a2 2 0 0 0 2.5-.5" opacity=".55" /></svg>',
                                    'coworkers'   => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M8.5 6.25A2.25 2.25 0 0 1 10.75 4h2.5A2.25 2.25 0 0 1 15.5 6.25V7H19a1.75 1.75 0 0 1 1.75 1.75v6.5A1.75 1.75 0 0 1 19 17h-2l-2.1 1.7a.75.75 0 0 1-1.2-.6V17H5a1.75 1.75 0 0 1-1.75-1.75v-6.5A1.75 1.75 0 0 1 5 7h3.5Z" opacity=".9" /><path fill="currentColor" d="M10.75 6.25v.75h2.5v-.75a.75.75 0 0 0-.75-.75h-1a.75.75 0 0 0-.75.75Zm-4.5 5.25H18v1H6.25Z" opacity=".55" /></svg>',
                                ];

                                $support_icons = [
                                    'email_whatsapp' => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4.5 5A2.5 2.5 0 0 1 7 2.5h6.25A2.75 2.75 0 0 1 16 5.25V9l2.25-1.6A1 1 0 0 1 19.85 8V15a2.75 2.75 0 0 1-2.75 2.75h-2.18L12 19.75l.68-2H7A2.5 2.5 0 0 1 4.5 15.25Z" opacity=".26" /><path fill="currentColor" d="M6 6.25v7.5l4.85-2.85a1.25 1.25 0 0 1 1.3 0L17 13.75V6.25Z" /><path fill="currentColor" d="M9.25 9.75a.75.75 0 1 1 1.5 0v.25a2 2 0 0 0 2 2h.5a.75.75 0 0 1 0 1.5H12a3.5 3.5 0 0 1-3.5-3.5Z" opacity=".6" /></svg>',
                                    'email'          => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4.25 5.5A1.75 1.75 0 0 1 6 3.75h12a1.75 1.75 0 0 1 1.75 1.75v12.5H4.25Z" opacity=".26" /><path fill="currentColor" d="M6 6.5v9.5h12V6.5l-6 3.7Z" /><path fill="currentColor" d="M6.5 6h11l-5.5 3.35Z" opacity=".6" /></svg>',
                                    'whatsapp'       => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 3.25a8.75 8.75 0 0 0-7.7 12.95L3.1 20.5l4.42-1.18A8.75 8.75 0 1 0 12 3.25Z" /><path fill="currentColor" d="M12 5.25A6.75 6.75 0 0 1 12 18l-2-.6-.53.14L7 18l.75-2.6-.2-.52A6.75 6.75 0 0 1 12 5.25Z" opacity=".24" /><path fill="currentColor" d="M10 7.75a.75.75 0 0 0-.62.33l-.74 1.08a.9.9 0 0 0-.1.76 6 6 0 0 0 3.54 3.54.9.9 0 0 0 .76-.1l1.08-.74a.75.75 0 0 0 .33-.62.75.75 0 0 0-.44-.69l-1-.46a.75.75 0 0 0-.9.22l-.27.35a4.14 4.14 0 0 1-1.21-1.21l.35-.27a.75.75 0 0 0 .22-.9l-.46-1A.75.75 0 0 0 10 7.75Z" /></svg>',
                                    'support'        => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M12 3.5A8.5 8.5 0 1 0 20.5 12 8.5 8.5 0 0 0 12 3.5Zm0 2A6.5 6.5 0 1 1 5.5 12 6.5 6.5 0 0 1 12 5.5Z" /><path fill="currentColor" d="M12 8.75a3.25 3.25 0 1 1-3.25 3.25A3.25 3.25 0 0 1 12 8.75Zm0 8a.75.75 0 0 0-.75.75.75.75 0 0 0 1.5 0A.75.75 0 0 0 12 16.75Z" opacity=".6" /></svg>',
                                ];
                                ...
                                $access_icons = [
                                    ...
                                    'custom'      => '<svg viewBox="0 0 24 24" role="presentation" focusable="false"><path fill="currentColor" d="M4 10.75A2.75 2.75 0 0 1 6.75 8h2.3l1.28-1.52a2 2 0 0 1 3.08-.08l1.37 1.6h2.47A2.75 2.75 0 0 1 19 13.75l-2.08 2.05a1.75 1.75 0 0 1-2.48 0l-.69-.69-.74.74a1.75 1.75 0 0 1-2.48 0l-.71-.71-.92.92a2.1 2.1 0 0 1-2.97 0L4.5 12.6A2.75 2.75 0 0 1 4 10.75Z" /><path fill="currentColor" d="M7.25 11.5a.75.75 0 0 0-.53 1.28l1.64 1.64a.75.75 0 0 0 1.06 0l1.18-1.18 1.18 1.18a.75.75 0 0 0 1.06 0l1.17-1.17 1.1 1.1a.75.75 0 0 0 1.06-1.06L15.6 11a.75.75 0 0 0-.53-.22H14l-1-1.25-1 1.25H7.25Z" opacity=".6" /></svg>',
                                ];
