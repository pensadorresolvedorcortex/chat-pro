                                    ...
                                    <div class="juntaplay-group-card__footer">
                                        ...
                                        <div class="juntaplay-group-card__details-extended" hidden>
                                            ...
                                            <div class="juntaplay-group-card__details-actions">
                                                ...
                                                // Always route the popup CTA to the chat section, adjusting the label by role.
                                                $chat_target_url = $messages_base_url;

                                                if ($membership_status !== 'guest' && $chat_target_url !== '') {
                                                    if ($is_admin) {
                                                        $chat_label = __('Fale com Assinante', 'juntaplay');
                                                        $chat_link = $chat_target_url;
                                                    } elseif ($owner_id !== $current_user_id) {
                                                        $chat_label = __('Fale com Administrador', 'juntaplay');
                                                        $chat_link = $chat_target_url;
                                                    }
                                                }
                                                ?>
