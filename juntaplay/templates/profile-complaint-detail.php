...
$empty_illustration = isset($context['empty_illustration']) ? (string) $context['empty_illustration'] : '';
?>
<section class="juntaplay-complaints__detail" data-complaint-detail>
    ...
    <?php else : ?>
        <div class="juntaplay-complaints__placeholder">
            <?php if ($empty_illustration !== '') : ?>
                <div class="juntaplay-complaints__empty-illustration" aria-hidden="true">
                    <?php echo $empty_illustration; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </div>
            <?php endif; ?>
