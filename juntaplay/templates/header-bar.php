...
if (!function_exists('juntaplay_header_icon')) {
    function juntaplay_header_icon(string $icon): string
    {
        return match ($icon) {
            ...
            default => '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M4 5h16a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H7l-4 4V6a1 1 0 0 1 1-1Z" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 10h8M8 13h5" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        };
    }
}
