...
?>
<section class="juntaplay-groups" data-jp-groups data-page="1" data-pages="1" data-per-page="16" data-card-variant="spotlight" data-default-search="<?php echo esc_attr($current_search); ?>" data-default-category="<?php echo esc_attr($current_category); ?>" data-default-orderby="<?php echo esc_attr($current_orderby); ?>" data-default-order="<?php echo esc_attr($current_order); ?>" data-default-instant="<?php echo esc_attr($instant_access); ?>">
