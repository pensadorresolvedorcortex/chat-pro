...
<section class="juntaplay-relationship">
    <div class="juntaplay-relationship__halo" aria-hidden="true">
        <span class="juntaplay-relationship__blob juntaplay-relationship__blob--teal"></span>
        <span class="juntaplay-relationship__blob juntaplay-relationship__blob--violet"></span>
        <span class="juntaplay-relationship__gridlines"></span>
    </div>

    <div class="juntaplay-relationship__container">
        <div class="juntaplay-relationship__glass">
            <div class="juntaplay-relationship__grid">
                <header class="juntaplay-relationship__header">
                    <div class="juntaplay-relationship__chips">
                        <span class="juntaplay-chip juntaplay-chip--primary"><?php echo esc_html__('Passo 1 de 2', 'juntaplay'); ?></span>
                        <?php if ($relationship_label !== '') : ?>
                            <span class="juntaplay-chip juntaplay-chip--ghost"><?php echo esc_html($relationship_label); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if ($relationship_price !== '' || $relationship_service !== '') : ?>
                        <div class="juntaplay-relationship__summary">
                            <?php if ($relationship_price !== '') : ?>
                                <div class="juntaplay-relationship__summary-line">
                                    <span><?php echo esc_html__('Valor por participante', 'juntaplay'); ?></span>
                                    <strong><?php echo wp_kses_post($relationship_price); ?></strong>
                                </div>
                            <?php endif; ?>
                            <?php if ($relationship_service !== '') : ?>
                                <div class="juntaplay-relationship__summary-line">
                                    <span><?php echo esc_html__('Serviço', 'juntaplay'); ?></span>
                                    <strong><?php echo esc_html($relationship_service); ?></strong>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                ...
                <div class="juntaplay-relationship__panel">
                            ...
                            <?php foreach ($relationship_cards as $card) :
                                ...
                                <label class="<?php echo esc_attr(implode(' ', $card_classes)); ?>">
                                    <input
                                        ...
                                        <?php echo $card_locked && !$is_active ? ' data-locked="1"' : ''; ?>
                                    />
