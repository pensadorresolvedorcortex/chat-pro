...
if (defined('JP_URL') && JP_URL !== '') {
    $google_icon = trailingslashit(JP_URL) . 'assets/images/google.png';
} else {
    $google_icon = plugins_url('../../assets/images/google.png', __FILE__);
}
...
$providers = apply_filters(
    ...
    [
        ...
        [
            ...
            'register_label'  => __('Criar conta com Google', 'juntaplay'),
            'href'            => '#',
            'icon'            => $google_icon,
            'popup'           => true,
        ],
