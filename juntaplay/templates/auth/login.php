                        ...
                        <form class="juntaplay-auth__form" method="post" action="<?php echo esc_url($current_url); ?>" data-register-wizard="1" data-step="1">
                            ...
                            <div class="juntaplay-auth__steps" data-auth-register-steps>
                                ...
                                <div class="juntaplay-auth__step is-active" data-auth-step="1">
                                    ...
                                    <div class="juntaplay-auth__field">
                                        <label for="jp_register_cpf"><?php esc_html_e('CPF', 'juntaplay'); ?></label>
                                        <input type="text" name="jp_register_cpf" id="jp_register_cpf" inputmode="numeric" autocomplete="off" placeholder="000.000.000-00" value="<?php echo esc_attr($register_cpf); ?>" data-cpf-input <?php disabled(!$can_register); ?> required>
                                        <?php
