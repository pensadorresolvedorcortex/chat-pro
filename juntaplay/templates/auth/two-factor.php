...
$footer_logo_url   = defined('JP_URL') ? JP_URL . 'assets/images/juntaplay-icone.png' : '';

if ($logo_url === '' && defined('JP_DIR')) {
    $logo_url = plugins_url('../assets/images/juntaplay-email.png', __FILE__);
}

if ($footer_logo_url === '' && defined('JP_DIR')) {
    $footer_logo_url = plugins_url('../assets/images/juntaplay-icone.png', __FILE__);
}
