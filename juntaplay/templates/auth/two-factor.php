    ...
    <footer class="juntaplay-two-factor__footer" aria-label="<?php esc_attr_e('Mensagem institucional da JuntaPlay', 'juntaplay'); ?>">
        <div class="juntaplay-two-factor__footer-card">
            ...
            <?php if ($footer_heading !== '') : ?>
                <p class="juntaplay-two-factor__footer-heading"><?php echo esc_html($footer_heading); ?></p>
            <?php endif; ?>
            <?php foreach ($footer_lines as $line) : ?>
                <p class="juntaplay-two-factor__footer-text"><?php echo esc_html($line); ?></p>
            <?php endforeach; ?>
            <?php if ($footer_pills) : ?>
                <div class="juntaplay-two-factor__footer-pills" role="list">
                    <?php foreach ($footer_pills as $pill) : ?>
                        <span role="listitem"><?php echo esc_html($pill); ?></span>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
            <?php if ($footer_copy !== '') : ?>
                <p class="juntaplay-two-factor__footer-copy"><?php echo esc_html($footer_copy); ?></p>
            <?php endif; ?>
        </div>
