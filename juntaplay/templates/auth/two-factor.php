...
$logo_url            = defined('JP_URL') ? JP_URL . 'assets/images/juntaplay-email.png' : '';
$footer_logo_url     = defined('JP_URL') ? JP_URL . 'assets/images/juntaplay-email-.png' : '';
        ...
        <div class="juntaplay-two-factor__footer-card">
            <?php if ($footer_logo_url !== '') : ?>
                <div class="juntaplay-two-factor__footer-logo">
                    <img src="<?php echo esc_url($footer_logo_url); ?>" alt="<?php esc_attr_e('JuntaPlay', 'juntaplay'); ?>" loading="lazy">
                </div>
            <?php endif; ?>
            <p class="juntaplay-two-factor__footer-heading"><?php esc_html_e('Gestão inteligente para um futuro compartilhado.', 'juntaplay'); ?></p>
            <p class="juntaplay-two-factor__footer-text"><?php esc_html_e('Construímos pontes entre conhecimento, propósito e prosperidade.', 'juntaplay'); ?></p>
            <p class="juntaplay-two-factor__footer-text"><?php esc_html_e('Aqui, cada ideia conecta pessoas, e cada comunidade impulsiona resultados.', 'juntaplay'); ?></p>
            <p class="juntaplay-two-factor__footer-text"><?php esc_html_e('Se precisar de suporte, fale com nossa equipe pelo e-mail contato@agenciadigitalspaulo.com.br', 'juntaplay'); ?></p>
            <div class="juntaplay-two-factor__footer-pills" role="list">
                <span role="listitem"><?php esc_html_e('Compartilhar', 'juntaplay'); ?></span>
                <span role="listitem"><?php esc_html_e('Construir', 'juntaplay'); ?></span>
                <span role="listitem"><?php esc_html_e('Crescer', 'juntaplay'); ?></span>
            </div>
