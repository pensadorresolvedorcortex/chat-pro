...
$has_credentials = !empty($has_credentials);
?>
    ...
    <div class="juntaplay-group-modal__body">
        <div class="juntaplay-group-card__access-panel" data-group-access-panel>
            ...
            <?php if (!$has_credentials) : ?>
                <p class="juntaplay-group-card__access-hint" data-group-access-hint>
                    <?php if ($is_admin) : ?>
                        <?php esc_html_e('Você ainda não cadastrou as credenciais de acesso deste grupo.', 'juntaplay'); ?>
                    <?php else : ?>
                        <?php esc_html_e('O administrador ainda não cadastrou os dados de acesso deste grupo. Você receberá um e-mail assim que estiverem disponíveis.', 'juntaplay'); ?>
                    <?php endif; ?>
                </p>
            <?php else : ?>
                <p class="juntaplay-group-card__access-hint" data-group-access-hint>
                    <?php if ($is_admin) : ?>
                        <?php esc_html_e('Credenciais cadastradas.', 'juntaplay'); ?>
                    <?php else : ?>
        ...
        <div class="juntaplay-group-modal__cta">
            <?php if ($is_admin && !$has_credentials) : ?>
                <button
                    type="button"
                    class="juntaplay-button juntaplay-button--primary"
                    data-group-access-register
                    data-group-id="<?php echo esc_attr((string) $group_id); ?>"
                >
                    <?php esc_html_e('Cadastrar credenciais', 'juntaplay'); ?>
                </button>
            <?php endif; ?>
            <button
                type="button"
