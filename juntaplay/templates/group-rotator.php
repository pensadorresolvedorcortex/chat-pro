...
>
    ...
    <?php if (!empty($rotator_directory_url) && $rotator_cta_label !== '') : ?>
        <div class="juntaplay-service-grid__footer">
            <a class="juntaplay-service-grid__cta" href="<?php echo esc_url($rotator_directory_url); ?>">
                <?php echo esc_html($rotator_cta_label); ?>
            </a>
        </div>
    <?php endif; ?>
</section>
