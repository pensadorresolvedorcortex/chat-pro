...
$illustration_markup = isset($illustration_markup) ? (string) $illustration_markup : '';
...
>
    <?php if ($illustration_markup !== '') : ?>
        <div class="juntaplay-thankyou__media" aria-hidden="true">
            <?php echo $illustration_markup; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        </div>
    <?php endif; ?>
