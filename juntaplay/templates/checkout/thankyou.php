...
$initial_state   = $is_completed ? 'success' : 'pending';
$auto_transition = $is_completed ? '0' : '1';
    ...
    <div class="jp-checkout-flow__wrapper">
        <section class="jp-checkout-flow__stage jp-checkout-flow__stage--pending<?php echo $initial_state === 'pending' ? ' is-active' : ''; ?>" data-jp-stage="pending" aria-live="polite">
            <div class="jp-checkout-flow__card">
                ...
                <p class="jp-checkout-flow__lead"><?php esc_html_e('Estamos validando as informações do seu pedido e preparando a ativação da sua assinatura.', 'juntaplay'); ?></p>
                <p class="jp-checkout-flow__lead"><?php esc_html_e('Esse processo leva apenas alguns instantes. Assim que tudo estiver confirmado nós mostraremos os próximos passos aqui mesmo.', 'juntaplay'); ?></p>
        ...
        <section class="jp-checkout-flow__stage jp-checkout-flow__stage--success<?php echo $initial_state === 'success' ? ' is-active' : ''; ?>" data-jp-stage="success" aria-live="polite">
            <div class="jp-checkout-flow__success">
                <div class="jp-checkout-flow__card">
                    <div class="jp-checkout-flow__icon" aria-hidden="true">✓</div>
                    <h1 class="jp-checkout-flow__title"><?php esc_html_e('Parabéns! Sua assinatura foi ativada.', 'juntaplay'); ?></h1>
                    <p class="jp-checkout-flow__lead">
                        <?php
                        printf(
                            /* translators: %1$s: customer name, %2$s: primary item */
                            esc_html__('Bem-vindo(a) ao grupo %2$s, %1$s! Agora é só acessar o painel para começar a participar.', 'juntaplay'),
                            esc_html($customer_name ?: ''),
                            esc_html($primary_item ?: __('seu grupo', 'juntaplay'))
                        );
                        ?>
                    </p>
                    <?php if (!empty($success_image_url)) : ?>
                        <div class="jp-checkout-flow__illustration">
                            <img src="<?php echo esc_url($success_image_url); ?>" alt="<?php esc_attr_e('Confirmação da assinatura JuntaPlay', 'juntaplay'); ?>">
                        </div>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <p class="jp-checkout-flow__footer-hint"><?php esc_html_e('Estamos redirecionando automaticamente…', 'juntaplay'); ?></p>
                </div>
                ...
                <div class="jp-checkout-flow__success-inner">
                    ...
                    <div class="jp-checkout-flow__items">
                        <h2><?php esc_html_e('Itens confirmados', 'juntaplay'); ?></h2>
