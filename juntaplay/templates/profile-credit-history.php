...
$pix_setup_url      = isset($context['pix_setup_url']) ? (string) $context['pix_setup_url'] : '';
...
>
    ...
    <div class="juntaplay-wallet__content juntaplay-wallet__grid">
            ...
            <section class="juntaplay-wallet__withdraw">
                ...
                <?php if ($requires_destination) : ?>
                    <div class="juntaplay-wallet__alert juntaplay-wallet__alert--warning">
                        <?php if ($pix_setup_url !== '') : ?>
                            <a class="juntaplay-wallet__link" href="<?php echo esc_url($pix_setup_url); ?>" data-profile-quick data-profile-quick-category="finance" data-profile-quick-tab="finance_preferences">
                                <?php esc_html_e('Cadastre uma chave Pix para habilitar saques.', 'juntaplay'); ?>
                            </a>
                        <?php else : ?>
                            <?php esc_html_e('Cadastre uma chave Pix para habilitar saques.', 'juntaplay'); ?>
                        <?php endif; ?>
