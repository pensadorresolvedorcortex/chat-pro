...
define( 'WC_PLS_VERSION', self::VERSION );
    ...
    private function includes() {
        require_once WC_PLS_PATH . 'includes/juntaplay-thankyou-helper.php';
    ...
    /**
     * Declare compatibility with WooCommerce features (e.g. HPOS and Checkout Blocks)
     * to avoid the admin notice for incompatible extensions.
     */
