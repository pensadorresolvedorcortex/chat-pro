    ...
    async function loadMessages() {
      ...
      try {
        ...
        if (data && data.success) {
          const payload = data.data && data.data.messages ? data.data.messages : data.messages;
    ...
    async function handleUpload() {
      ...
      fileInput.addEventListener('change', async function () {
        ...
        try {
          ...
          const data = await res.json();
          const uploadUrl = data && data.success ? (data.data && data.data.url ? data.data.url : data.url) : '';
          if (uploadUrl) {
            await sendMessage({ image_url: uploadUrl });
          } else {
