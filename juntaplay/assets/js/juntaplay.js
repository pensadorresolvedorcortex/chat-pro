(function ($) {
    ...
    var jpGroupModal = (function () {
        var ajaxEndpoint = (window.JuntaPlay && window.JuntaPlay.ajax) ? window.JuntaPlay.ajax : (window.ajaxurl || '');
        ...
        function load(action, groupId) {
            ...
            if (ajaxNonce) {
                payload.nonce = ajaxNonce;
            }

            jQuery.post(ajaxEndpoint, payload).done(function (response) {
