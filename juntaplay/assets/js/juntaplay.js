(function ($) {
    ...
    function initGroupWizard($form) {
        ...
        var $viewRoot = $form.closest('[data-group-view-root]');
        ...
        if (initialPlanRequired && $viewRoot.length) {
            var initialPoolData = $viewRoot.data('poolData') || null;
            var initialPlans = normalizePoolPlans($viewRoot.data('poolPlans'));
            if (initialPoolData && initialPlans.length) {
                renderPlanOptions($viewRoot, initialPoolData, initialPlans);
            }
        }
    ...
    $(document).on('click', '[data-group-pool-apply]', function (event) {
        ...
        if (plans.length && $viewRoot.length) {
            if ($form.length) {
                $form.data('planRequired', true);
                $form.trigger('jp:groupPlanRequired', [true]);
