(function ($) {
    ...
    $(document).on('change', '.juntaplay-relationship-card input[type="radio"]', function () {
        var $input = $(this);
        ...
        var $cards = $('.juntaplay-relationship-card input').filter(function () {
            return ($(this).attr('name') || '').toString() === name;
        }).closest('.juntaplay-relationship-card');

        $cards.removeClass('is-active');
        $input.closest('.juntaplay-relationship-card').addClass('is-active');
    });
