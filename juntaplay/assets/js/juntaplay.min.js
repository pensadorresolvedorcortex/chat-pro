(function ($) {
    ...
    function initGroupWizard($form) {
        ...
        var $stepper = $form.find('[data-group-stepper] .juntaplay-steps__item'), $accessStep = $form.find('[data-group-step][data-step-index="4"]'), $accessStepper = $form.find('[data-group-stepper] .juntaplay-steps__item[data-step-index="4"]'), $progress = $();
        var currentIndex = 0;
