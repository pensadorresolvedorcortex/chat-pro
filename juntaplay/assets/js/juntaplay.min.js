(function ($) {
    ...
    function initGroupWizard($form) {
        ...
        var $stepper = $form.find('[data-group-stepper] .juntaplay-steps__item'), $accessStep = $form.find('[data-group-step][data-step-index="4"]'), $accessStepper = $form.find('[data-group-stepper] .juntaplay-steps__item[data-step-index="4"]'), $progress = $form.find('[data-step-progress]');
        var currentIndex = 0;
        ...
        function updateWizardProgress() {
            ...
            var $availableSteps = $steps.filter(':not(.is-disabled)'), total = $availableSteps.length || $steps.length, activeIndex = $availableSteps.index($steps.eq(currentIndex));
        ...
        function showStep(index, direction) {
            ...
            var dir = direction || (index > currentIndex ? 1 : -1), target = index;
        ...
        $form.on('click', '[data-step-next]', function (event) {
            ...
            var accessTiming = ($form.find('[data-access-timing]').val() || '').toString(), isImmediate = accessTiming === 'immediate';
