...
add_action('init', static function (): void {
    add_shortcode('juntaplay_chatonline', static function (): string {
        ...
        if ($current_user_avatar === '' && $current_id > 0) {
            $current_user_avatar = get_avatar_url($current_id, ['size' => 64]);
        }

        $avatar_fallback      = $current_user_avatar;
        ...
        foreach ($owned_groups as $group) {
            ...
            foreach ($member_ids as $member_id) {
                ...
                $member_avatar = get_avatar_url($member_id, ['size' => 64]);
        ...
        if ($default_member_group && ($default_member_group['owner_id'] ?? 0)) {
            ...
            if ($admin_user) {
                $subscriber_admin = [
                    ...
                    'avatar' => get_avatar_url($admin_id, ['size' => 64]),
                ];
            }
        }
        ...
        <script>
            (function () {
                ...
                const fallbackAvatar = data.fallbackAvatar || '';
                ...
                const renderGroups = () => {
                    ...
                    data.groups.forEach((group) => {
                        ...
                        groupIcon.className = 'juntaplay-group-card_avatar juntaplay-service-card_icon has-image';
