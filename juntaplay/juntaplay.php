...
add_action('init', static function (): void {
    add_shortcode('juntaplay_chatonline', static function (): string {
        ...
        if ($avatar_fallback === '') {
            $avatar_fallback = get_avatar_url($current_id, ['size' => 128]) ?: 'https://www.gravatar.com/avatar/?d=mp&s=128';
        }
        ...
        <style>
            ...
            .jp-chat-avatar-glass {
                ...
                border-radius: 50%;
                padding: 5px;
                background: linear-gradient(135deg, rgba(255, 255, 255, 0.3), rgba(148, 163, 184, 0.2));
            ...
            .jp-chat-avatar-glass:hover {
                ...
                box-shadow:
                    0 16px 45px rgba(15, 23, 42, 0.24),
                    0 0 0 1px rgba(255, 255, 255, 0.32),
                    0 0 40px rgba(14, 165, 233, 0.38);
                background: linear-gradient(135deg, rgba(255, 255, 255, 0.42), rgba(125, 211, 252, 0.25));
                border-color: rgba(255, 255, 255, 0.75);
            }

            .jp-chat-avatar-shine {
                position: absolute;
                inset: 0;
                background: radial-gradient(circle at 25% 25%, rgba(255, 255, 255, 0.4), transparent 45%),
            ...
            .jp-chat-avatar-img {
                ...
                background: radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.12));
                position: relative;
                z-index: 1;
            }
            ...
            <section class="jp-chat-panel" data-jp-chat-panel>
                <header class="jp-chat-header" data-jp-chat-header>
                    <div class="jp-chat-avatar-glass" data-jp-chat-avatar-shell>
                        <span class="jp-chat-avatar-shine" aria-hidden="true"></span>
