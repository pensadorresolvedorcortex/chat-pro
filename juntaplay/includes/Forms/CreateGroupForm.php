...
class CreateGroupForm {
    ...
    public static function render_form() {
        ...
        if ( wp_script_is( 'juntaplay', 'registered' ) ) {
        ...
        $icon_placeholder = ServiceIcons::fallback();
        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="jplay-form jplay-form--create-group">
            ...
            <div class="jplay-field">
                <label for="jplay_group_icon" class="jplay-label">
                    <?php esc_html_e( 'Ícone do grupo', 'juntaplay' ); ?>
                </label>
                <div class="juntaplay-cover-field" data-group-cover data-placeholder="<?php echo esc_url( $icon_placeholder ); ?>">
                    <div class="juntaplay-cover-field__preview" data-group-cover-preview>
                        <img src="<?php echo esc_url( $icon_placeholder ); ?>" alt="" loading="lazy" />
                    </div>
                    <div class="juntaplay-cover-field__actions">
                        <button type="button" class="jplay-button jplay-button--secondary" data-group-cover-select>
                            <?php esc_html_e( 'Escolher ícone', 'juntaplay' ); ?>
                        </button>
                        <button type="button" class="jplay-button jplay-button--link" data-group-cover-remove>
                            <?php esc_html_e( 'Remover', 'juntaplay' ); ?>
                        </button>
                    </div>
                    <input type="hidden" id="jplay_group_icon" name="jplay_group_icon" value="0" data-group-cover-input />
                </div>
                <p class="jplay-form__help"><?php esc_html_e( 'Envie um ícone quadrado com pelo menos 256×256px. Se não selecionar, usaremos o ícone automático do serviço.', 'juntaplay' ); ?></p>
            </div>
    ...
    public static function handle_submission() {
        ...
        $icon_id = isset( $_POST['jplay_group_icon'] ) ? absint( wp_unslash( $_POST['jplay_group_icon'] ) ) : 0;
        ...
        $_POST['jplay_group_icon']         = $icon_id; // phpcs:ignore WordPress.Security.NonceVerification.Missing
