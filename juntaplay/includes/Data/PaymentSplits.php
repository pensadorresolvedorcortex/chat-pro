...
class PaymentSplits
{
    ...
    public static function create(array $data): int
    {
        ...
        $processed_at   = isset($data['processed_at']) && $data['processed_at'] !== '' ? (string) $data['processed_at'] : null;
        $created_at     = isset($data['created_at']) && $data['created_at'] !== '' ? (string) $data['created_at'] : current_time('mysql');
        ...
        $inserted = $wpdb->insert(
            ...
            ['%d', '%d', '%s', '%f', '%d', '%d', '%d', '%f', '%f', '%f', '%f', '%s', '%s', '%s', '%s', '%s']
        );
