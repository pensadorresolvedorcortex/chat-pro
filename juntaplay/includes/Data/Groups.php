...
class Groups
{
    ...
    {
        // Reserved slots do not reduce available slots; only active members count.
        return max(0, $slots_total - $members_count);
    }
    ...
    public static function get_groups_for_user(int $user_id): array
    {
        ...
        if ($has_exit_effective) {
            $member_where  .= ' AND (gm.exit_effective_at IS NULL OR gm.exit_effective_at > %s)';
            $member_params[] = current_time('mysql');
        }
