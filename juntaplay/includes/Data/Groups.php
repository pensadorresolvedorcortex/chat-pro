...
class Groups
{
    ...
    public static function create(array $data): int
    {
        ...
        $relationship     = isset($data['relationship_type']) ? sanitize_key((string) $data['relationship_type']) : '';
        $relationship_set = array_keys(self::get_relationship_options());
        if (!in_array($relationship, $relationship_set, true)) {
            $relationship = '';
        }
