...
class Installer
{
    ...
    {
        $this->create_tables();
        $this->upgrade_group_members_columns();
    ...
    private function create_tables(): void
    {
        ...
        $group_members_table = "CREATE TABLE {$wpdb->prefix}jp_group_members (
            ...
            exit_requested_at DATETIME NULL,
            exit_effective_at DATETIME NULL,
            PRIMARY KEY (id),
    ...
    public static function bootstrap_cron(): void
    {
        ...
        add_action('juntaplay_cron_process_group_exits', ['\\JuntaPlay\\Data\\GroupMembers', 'process_scheduled_exits']);
    }
    ...
    public static function schedule_cron(): void
    {
        ...
        if (!wp_next_scheduled('juntaplay_cron_process_group_exits')) {
            wp_schedule_event(time() + DAY_IN_SECONDS, 'daily', 'juntaplay_cron_process_group_exits');
        }
    }
    ...
    {
        $installer = new self();
        $installer->upgrade_group_members_columns();
    ...
    private function upgrade_group_members_columns(): void
    {
        global $wpdb;
        ...
        $columns = [
            'exit_requested_at' => "ALTER TABLE $table ADD COLUMN exit_requested_at DATETIME NULL AFTER joined_at",
            'exit_effective_at' => "ALTER TABLE $table ADD COLUMN exit_effective_at DATETIME NULL AFTER exit_requested_at",
        ];
