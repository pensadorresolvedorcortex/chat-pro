...
<html lang="pt-BR">
                ...
                <td align="center">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:36px;overflow:hidden;box-shadow:0 28px 64px rgba(15, 23, 42, 0.18);">
                        ...
                        <?php if ($footer_heading !== '' || $footer_lines) : ?>
                            <?php
                            $footer_pills = [
                                __('Comunidade', 'juntaplay'),
                                __('Conteúdo', 'juntaplay'),
                                __('Crescimento', 'juntaplay'),
                            ];
                            ?>
                            <tr>
                                <td style="padding:0;">
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:linear-gradient(135deg,#0f172a,#1d3a72);">
                                        <tr>
                                            <td style="padding:48px 32px 52px;text-align:center;color:#ffffff;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,'Noto Sans',sans-serif;">
                                                <div style="display:inline-flex;gap:10px;margin-bottom:24px;">
                                                    <span style="display:inline-block;width:12px;height:12px;border-radius:999px;background:#00ccc0;"></span>
                                                    <span style="display:inline-block;width:12px;height:12px;border-radius:999px;background:rgba(255,255,255,0.55);"></span>
                                                    <span style="display:inline-block;width:12px;height:12px;border-radius:999px;background:rgba(255,255,255,0.28);"></span>
                                                </div>
                                                ...
                                                <?php endforeach; ?>
                                                <div style="margin-top:34px;display:inline-flex;gap:12px;flex-wrap:wrap;justify-content:center;">
                                                    <?php foreach ($footer_pills as $pill) : ?>
                                                        <span style="display:inline-block;padding:10px 20px;border-radius:999px;background:rgba(255,255,255,0.12);color:#e0fdfa;font-size:12px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;">
     ...
     */
    private static function default_footer_lines(): array
    {
        $year = gmdate('Y');

        return [
            __('JuntaPlay - Transformando conhecimento em comunidades vibrantes.', 'juntaplay'),
            __('Se precisar de ajuda, basta responder este e-mail ou falar com o suporte JuntaPlay.', 'juntaplay'),
            __('Precisa de ajuda? Fale com a gente em contato@agenciadigitalspaulO.com.br', 'juntaplay'),
