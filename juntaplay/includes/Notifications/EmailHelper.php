...
<html lang="pt-BR">
    ...
    <body style="margin:0;padding:0;background:#00CCC0;">
        <?php if ($preheader !== '') : ?>
            <div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#00CCC0;">
                <?php echo esc_html($preheader); ?>
            </div>
        <?php endif; ?>
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#00CCC0;padding:32px 16px;">
            <tr>
                <td align="center">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:32px;overflow:hidden;">
                        <tr>
                            <td style="padding:40px 32px 24px;text-align:center;background:#ffffff;">
                                <?php if ($logo_url !== '') : ?>
                        ...
                        <?php if ($footer) : ?>
                            ...
                            ?>
                            <tr>
                                <td style="padding:0 32px 40px;background:#ffffff;">
        ...
        foreach ($blocks as $block) {
            ...
            switch ($type) {
                case 'paragraph':
                    ...
                    $html .= sprintf(
                        '<p style="margin:0 0 16px;color:#0f172a;font-size:15px;line-height:1.7;">%s</p>',
                        esc_html($content)
                    );
                    break;
                ...
                case 'list':
                    ...
                    $html .= '<ul style="margin:0 0 16px;padding-left:20px;color:#0f172a;font-size:15px;line-height:1.7;">';
                ...
                case 'button':
                    ...
                    $html .= sprintf(
                        '<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:24px auto 32px;">'
                        . '<tr><td style="background:#0f172a;border-radius:999px;"><a href="%s" style="display:inline-block;padding:14px 32px;color:#ffffff;font-weight:600;text-decoration:none;font-size:15px;">%s</a></td></tr></table>',
                        esc_url($url),
                        esc_html($label)
                    );
                    break;
                ...
                case 'code':
                    ...
                    $html .= sprintf(
                        '<p style="margin:0 0 20px;text-align:center;"><span style="display:inline-block;padding:12px 24px;background:#0f172a;color:#ffffff;font-size:22px;letter-spacing:0.3em;border-radius:18px;font-weight:700;">%s</span></p>',
                        esc_html($content)
                    );
                    break;
    ...
    private static function get_logo_url(): string
    {
        ...
        $url = trailingslashit(JP_URL) . 'assets/images/Juntaplay.svg';
