...
class ChatShortcode
{
    ...
    public static function render_chat(): string
    {
        ...
        $is_endpoint_context = doing_action('woocommerce_account_juntaplay-chat_endpoint');

        // Always prefer rendering inside the WooCommerce endpoint action to avoid
        // duplicates in themes that embed the shortcode elsewhere on the page.
        if (!$is_endpoint_context) {
            return '';
        }
    ...
    public static function render_account_endpoint(): void
    {
        ...
        echo '<div class="juntaplay-profile__panels">' . $content . '</div>';
    }
