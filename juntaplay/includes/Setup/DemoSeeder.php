...
class DemoSeeder
{
    ...
    private function ensure_demo_cover_attachment(): int
    {
        ...
        $contents = $this->load_placeholder_cover();
        if ($contents === '') {
            return 0;
        }

        $upload = wp_upload_bits('juntaplay-group-cover-demo.svg', null, $contents);
    ...
    private function load_placeholder_cover(): string
    {
        $paths = [];

        if (defined('JP_DIR')) {
            $paths[] = trailingslashit(JP_DIR) . 'assets/img/group-cover-placeholder.svg';
            $paths[] = trailingslashit(JP_DIR) . 'assets/images/thankyou-placeholder.svg';
        }

        $paths[] = __DIR__ . '/../../assets/img/group-cover-placeholder.svg';
        $paths[] = __DIR__ . '/../../assets/images/thankyou-placeholder.svg';
