...
class CheckoutThankYou
{
    ...
    private function should_override_order(WC_Order $order): bool
    {
        ...
        $split_registered = (string) $order->get_meta('_juntaplay_split_processed', true) !== '';
        $eligible         = ($via_callback || $split_registered) && in_array($status, ['processing', 'completed'], true);
