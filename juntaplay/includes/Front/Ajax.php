...
class Ajax
{
    ...
    private function infer_group_cover_flag_from_referer(): string
    {
    ...
    private function is_group_cover_upload_request(?WP_User $user = null): bool
    {
        ...
        if ($requires_flag) {
            ...
            if ($flag === '') {
                $flag = $this->infer_group_cover_flag_from_referer();
            }
        ...
        if (!empty($user->allcaps['upload_files']) || !empty($user->caps['upload_files'])) {
            return false;
        }
