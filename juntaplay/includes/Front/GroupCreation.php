...
class GroupCreation
{
    ...
    private function render_relationship_fields(string $selected): string
    {
        ...
        $description_map = [
            'cohabitants' => __('Ideal para quem compartilha o mesmo lar e quer dividir as assinaturas com praticidade.', 'juntaplay'),
        ...
        ob_start();
        ?>
        <div class="juntaplay-relationship-options">
            <div class="juntaplay-relationship__cards">
                <?php foreach ($options as $value => $label) :
                    $key          = $value !== '' ? $value : 'default';
                    $icon         = $icon_map[$value] ?? '';
                    $description  = $description_map[$value] ?? '';
                    $card_classes = ['juntaplay-relationship-card', 'juntaplay-relationship-card--' . sanitize_html_class($key)];
                    if ($selected === $value) {
                    ...
                    <label class="<?php echo esc_attr(implode(' ', $card_classes)); ?>">
                        ...
                        <span class="juntaplay-relationship-card__content">
                            <span class="juntaplay-relationship-card__label"><?php echo esc_html($label); ?></span>
                            <?php if ($description !== '') : ?>
                                <span class="juntaplay-relationship-card__description"><?php echo esc_html($description); ?></span>
                            <?php endif; ?>
                        </span>
                    </label>
                <?php endforeach; ?>
