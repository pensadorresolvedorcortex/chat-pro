...
class Shortcodes
{
    ...
    public function profile(): string
    {
        ...
        if (function_exists('wc_get_page_permalink')) {
            ...
            $chat_link    = wc_get_endpoint_url('juntaplay-chat', '', $account_page ?: home_url('/minha-conta'));
        }

        if (!$chat_link) {
            $chat_link = home_url('/minha-conta/juntaplay-chat');
        }
        ...
        $chat_section = [
            ...
            'description' => 'Canal direto para sanar dúvidas e enviar mensagens sobre o grupo.',
            'url'         => $chat_link,
            'link'        => $chat_link,
            'icon'        => 'message',
            'type'        => 'chat',
        ...
        if (is_array($profile_sections)) {
            array_unshift($profile_sections, $chat_section);
        } else {
            $profile_sections = [$chat_section];
        }
