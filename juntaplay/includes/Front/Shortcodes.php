        ...
        <section class="jp-groups-slider" id="<?php echo esc_attr($slider_id); ?>">
            ...
            <div class="jp-groups-slider__shell">
                ...
                <div class="jp-groups-slider__track" role="list">
                    ...
                    $avatar_count = $user_count > 0 ? min(3, $user_count) : 0;
                    ?>
                    <article class="jp-groups-card <?php echo esc_attr($card_variant); ?>" role="listitem" <?php echo $group_id > 0 ? 'data-group-card data-group-id="' . esc_attr((string) $group_id) . '"' : 'data-group-card'; ?>>
                        ...
                        <?php if ($avatar_count > 0) : ?>
                            <div class="jp-groups-card__avatars" aria-hidden="true">
                                <?php for ($i = 0; $i < $avatar_count; $i++) : ?>
                                    <span class="jp-groups-card__avatar<?php echo $cover_url !== '' ? ' has-image' : ''; ?>"<?php echo $cover_url !== '' ? ' style="background-image: url(' . esc_url($cover_url) . ')"' : ''; ?>>
