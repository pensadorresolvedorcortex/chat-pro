        ...
        <section class="jp-groups-slider" id="<?php echo esc_attr($slider_id); ?>">
            ...
            <div class="jp-groups-slider__shell">
                ...
                <div class="jp-groups-slider__track" role="list">
                    ...
                    $data_attrs = sprintf(' data-group-card data-jp-group-open="1" data-group-id="%d"', $group_id);
                    $card_attrs = sprintf('data-group-card data-jp-group-open="1" data-group-id="%d"', $group_id);
                    ...
                    ?>
                    <article class="jp-groups-card <?php echo esc_attr($card_variant); ?>" role="listitem" <?php echo $group_id > 0 ? $card_attrs : 'data-group-card data-jp-group-open="1" data-group-id="0"'; ?>>
