...
class Profile
{
    ...
    private function build_group_hub_context(array $data): array
    {
        ...
        $pool_catalog = Pools::get_all_active_pools();
        $pool_featured = Pools::get_featured_pools(6);
    ...
    public function get_sections(): array
    {
        ...
        $member_for_messages = array_values(array_filter($groups_member_full, static function (array $group): bool {
            return isset($group['membership_status']) && (string) $group['membership_status'] === 'active';
        }));
        ...
        if ($selected_group && $is_admin_view) {
            ...
            $should_create_chat = $chat_admin_id > 0 && $chat_admin_id !== $current_user_id && $membership_status === 'active';
