...
class Profile
{
    ...
    private function is_group_cover_upload_request(): bool
    {
        ...
        if (!in_array($action, ['upload-attachment', 'query-attachments', 'juntaplay_group_edit_save'], true)) {
            return false;
        }
    ...
    public function maybe_grant_group_cover_upload_cap(
        ...
        if (!$this->group_cover_upload_context && !$this->is_group_cover_upload_request()) {
            return $allcaps;
        }
