...
class Profile
{
    ...
    public function handle_group_update(int $group_id, array $data, array $files = []): array
    {
        ...
        $support_type_input = isset($data['support_channel_type'])
            ? sanitize_key(wp_unslash($data['support_channel_type']))
            : '';
        $support_country_input = isset($data['support_channel_country'])
            ? sanitize_key(wp_unslash($data['support_channel_country']))
            : '';
        $support_value_input = isset($data['support_channel_value'])
            ? sanitize_text_field(wp_unslash($data['support_channel_value']))
            : '';
        $support_raw = sanitize_text_field(wp_unslash($data['support_channel'] ?? ''));
        $support_data = SupportChannel::normalize($support_type_input, $support_value_input, $support_country_input, $support_raw);
        $support_channel = $support_data['channel'] !== '' ? $support_data['channel'] : $support_raw;
        ...
        if ($support_data['errors']) {
            $errors = array_merge($errors, $support_data['errors']);
        }
        ...
        $payload = [
            ...
            'support_channel_type'   => $support_data['type'],
            'support_channel_value'  => $support_data['value'],
            'support_channel_country'=> $support_data['country'],
