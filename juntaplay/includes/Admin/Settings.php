...
class Settings
{
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $split_percentage = isset($general['split_percentage']) ? (float) $general['split_percentage'] : self::DEFAULT_SPLIT_PERCENTAGE;
                                $split_display    = number_format_i18n($split_percentage, 2);
                                ?>
                                <input
                                    type="text"
                                    inputmode="decimal"
    ...
    public function sanitize_general(array $input): array
    {
        ...
        $split = self::normalize_percentage_value($input['split_percentage'] ?? self::DEFAULT_SPLIT_PERCENTAGE);
    ...
    private static function normalize_percentage_value($value): float
    {
        if (is_string($value)) {
