...
class Settings
{
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $split_percentage = isset($general['split_percentage']) ? (float) $general['split_percentage'] : self::DEFAULT_SPLIT_PERCENTAGE; ?>
                                <input type="number" min="0" max="100" step="0.01" name="<?php echo esc_attr(self::OPTION_GENERAL); ?>[split_percentage]" value="<?php echo esc_attr(number_format((float) $split_percentage, 2, '.', '')); ?>" />
                                <p class="description"><?php esc_html_e('Percentual da plataforma aplicado sobre o valor do grupo para cálculo de split.', 'juntaplay'); ?></p>
                            </td>
                        </tr>
                        <tr>
    ...
    public function sanitize_general(array $input): array
    {
        ...
        $split = isset($input['split_percentage']) ? (float) $input['split_percentage'] : self::DEFAULT_SPLIT_PERCENTAGE;
        ...
        return [
            ...
            'split_percentage'    => (float) number_format($split, 2, '.', ''),
        ];
    }
    ...
    {
        $general = get_option(self::OPTION_GENERAL, []);
        $split   = isset($general['split_percentage']) ? (float) $general['split_percentage'] : self::DEFAULT_SPLIT_PERCENTAGE;
        ...
        return (float) number_format($split, 2, '.', '');
    }
