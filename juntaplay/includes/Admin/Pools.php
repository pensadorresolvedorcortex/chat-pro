...
class Pools
{
    ...
    public function render_page(): void
    {
        ...
        $pool_type = $edit_id > 0 ? PoolsData::get_type($edit_id) : 'simple';
    ...
    public function handle_save(): void
    {
        ...
        if (is_array($plans_input)) {
            foreach ($plans_input as $plan) {
                ...
                if ($plan_price < 0) {
                    $this->store_notice('error', esc_html__('O preço do plano deve ser maior ou igual a zero.', 'juntaplay'));
                    $this->redirect_back();
                }
