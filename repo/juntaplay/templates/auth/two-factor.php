...
$logo_url          = defined('JP_URL') ? JP_URL . 'assets/images/juntaplay-email.svg' : '';
$footer_logo_url   = defined('JP_URL') ? JP_URL . 'assets/images/Juntaplay.svg' : '';

if ($logo_url === '' && defined('JP_DIR')) {
    $logo_url = plugins_url('../assets/images/juntaplay-email.svg', __FILE__);
}

if ($footer_logo_url === '' && defined('JP_DIR')) {
    $footer_logo_url = plugins_url('../assets/images/Juntaplay.svg', __FILE__);
}
