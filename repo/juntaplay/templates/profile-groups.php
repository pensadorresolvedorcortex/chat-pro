...
if ($success_image === '') {
    $success_image = plugins_url('../assets/images/agradecimento.gif', __FILE__);
}
...
?>
<div id="jp-profile-groups" class="juntaplay-groups" data-groups data-role-filter="all" data-status-filter="all">
    ...
    <div class="juntaplay-groups__list">
        <div class="juntaplay-groups__cards juntaplay-service-grid juntaplay-grid" data-group-list>
            <?php if ($all_groups) : ?>
