...
if(empty($this->aof_options['login_form_align_type']) || $this->aof_options['login_form_align_type'] == 1) {
  ...
  $css_styles .= '.wps-login-container { height: 100%; display:flex;justify-content: center;align-items: center;flex-direction:column}';
}
else {
...
$css_styles .= '
  ...
  if( !empty($this->aof_options['login_button_border_color']) ) {
$css_styles .= '.button-primary, form#loginform .button-primary, form#registerform .button-primary, .button-primary {
  border-color:'. $this->aof_options['login_button_border_color'] .' !important;}';    
  }
  if( !empty($this->aof_options['login_button_hover_border_color']) ) {
    $css_styles .= 'form#loginform .button-primary.focus,form#loginform .button-primary.hover,form#loginform .button-primary:focus,form#loginform .button-primary:hover,
...
<style type="text/css">
<?php echo wp_kses_post($this->wps_compress_css($css_styles)); ?>
</style>
