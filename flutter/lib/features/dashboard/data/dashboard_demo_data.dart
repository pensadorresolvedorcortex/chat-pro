...
const demoQuickActions = [
  ...
  DashboardQuickAction(
    ...
    description: 'Monte um sprint rápido com 30 questões.',
    route: '/simulados/express',
  ),
  DashboardQuickAction(
  ...
  DashboardQuickAction(
    ...
    description: 'Acompanhe Flutter iOS, Strapi e operações.',
    route: '/operacoes/readiness',
  ),
];
