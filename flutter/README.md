...
>
> ⚠️ **Erro `com/android/builder/model/BuildType`**: esse stack trace indica que o projeto está usando AGP 7.x ou Kotlin < 2.0. Atualize para AGP 8.7+/Gradle 8.9 e Kotlin 2.0.21 (ou rode `python ../scripts/bootstrap_gradle_wrapper.py`) para que o plugin `dev.flutter.flutter-gradle-plugin` compile corretamente.
