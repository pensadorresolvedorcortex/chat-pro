	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
                ...
                $typography_scheme = class_exists( '\\Elementor\\Core\\Schemes\\Typography' ) ? \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1 : \Elementor\Scheme_Typography::TYPOGRAPHY_1;
                $this->add_group_control(
                        Elementor\Group_Control_Typography::get_type(),
                        array(
                                'name'     => 'btn_typograhy',
                                'scheme'   => $typography_scheme,
