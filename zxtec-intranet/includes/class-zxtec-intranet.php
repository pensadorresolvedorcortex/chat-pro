...
class ZXTEC_Intranet {
    ...
    public function client_meta_box( $post ) {
        ...
        $address = get_post_meta( $post->ID, '_zxtec_address', true );
        ...
        <p><label><?php _e( 'Endereco', 'zxtec' ); ?><br/>
        <textarea name="zxtec_address" class="widefat"><?php echo esc_textarea( $address ); ?></textarea></label></p>
        <?php
    }
    ...
    public function order_meta_box( $post ) {
        ...
        <p><label><?php _e( 'Endereco', 'zxtec' ); ?><br/>
        <input type="text" name="zxtec_order_address" value="<?php echo esc_attr( get_post_meta( $post->ID, '_zxtec_order_address', true ) ); ?>" class="widefat" /></label></p>
        <p><label><?php _e( 'CEP', 'zxtec' ); ?><br/>
        <input type="text" name="zxtec_order_zip" value="<?php echo esc_attr( get_post_meta( $post->ID, '_zxtec_order_zip', true ) ); ?>" class="widefat" /></label></p>
    ...
    public function save_post_meta( $post_id ) {
        ...
        switch ( $post_type ) {
            case 'zxtec_client':
                ...
                update_post_meta( $post_id, '_zxtec_address', sanitize_textarea_field( $_POST['zxtec_address'] ?? '' ) );
                break;
            case 'zxtec_service':
           ...
           case 'zxtec_order':
                ...
                $new_addr       = sanitize_text_field( $_POST['zxtec_order_address'] ?? '' );
    ...
    public function enqueue_admin_scripts( $hook ) {
        ...
        if ( strpos( $hook, 'zxtec_admin_panel' ) !== false ) {
...
JS;
    ...
    public function financial_page() {
        ...
        echo '<div class="wrap"><h1>' . esc_html__( 'Relatorio Financeiro', 'zxtec' ) . '</h1>';
    ...
    public function expense_page() {
        ...
        echo '<div class="wrap"><h1>' . esc_html__( 'Relatorio de Despesas', 'zxtec' ) . '</h1>';
    ...
    public function history_page() {
        ...
        echo '<div class="wrap"><h1>' . esc_html__( 'Historico de Servicos', 'zxtec' ) . '</h1>';
    ...
    public function contracts_page() {
        echo '<div class="wrap"><h1>' . esc_html__( 'Contratos Ativos', 'zxtec' ) . '</h1>';
    ...
    public function schedule_page() {
        echo '<div class="wrap"><h1>' . esc_html__( 'Agenda', 'zxtec' ) . '</h1>';
    ...
    public function notifications_page() {
        echo '<div class="wrap"><h1>' . esc_html__( 'Notificacoes', 'zxtec' ) . '</h1>';
        ...
        echo '<table class="widefat"><thead><tr><th>' . esc_html__( 'Colaborador', 'zxtec' ) . '</th><th>' . esc_html__( 'Mensagem', 'zxtec' ) . '</th><th>' . esc_html__( 'Data', 'zxtec' ) . '</th><th></th></tr></thead><tbody>';
    ...
    public function technician_map_page() {
        echo '<div class="wrap"><h1>' . esc_html__( 'Mapa de Tecnicos', 'zxtec' ) . '</h1>';
