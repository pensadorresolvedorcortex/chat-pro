...
class ZXTEC_Intranet {
    ...
    public function client_meta_box( $post ) {
        ...
        <input type="text" name="zxtec_zip" value="<?php echo esc_attr( $zip ); ?>" class="widefat zxtec-cep" data-address="zxtec_address" /></label></p>
        <p><label><?php _e( 'Endereco', 'zxtec' ); ?><br/>
        <textarea name="zxtec_address" class="widefat zxtec-address"><?php echo esc_textarea( $address ); ?></textarea></label></p>
        <?php
    }
    ...
    public function order_meta_box( $post ) {
        ...
        <p><label><?php _e( 'CEP', 'zxtec' ); ?><br/>
        <input type="text" name="zxtec_order_zip" value="<?php echo esc_attr( get_post_meta( $post->ID, '_zxtec_order_zip', true ) ); ?>" class="widefat zxtec-cep" data-address="zxtec_order_address" /></label></p>
        <p><label><?php _e( 'Endereco', 'zxtec' ); ?><br/>
        <input type="text" name="zxtec_order_address" value="<?php echo esc_attr( get_post_meta( $post->ID, '_zxtec_order_address', true ) ); ?>" class="widefat zxtec-address" /></label></p>
    ...
    public function save_post_meta( $post_id ) {
        ...
        switch ( $post_type ) {
            case 'zxtec_client':
                ...
                update_post_meta( $post_id, '_zxtec_zip', sanitize_text_field( $_POST['zxtec_zip'] ?? '' ) );
