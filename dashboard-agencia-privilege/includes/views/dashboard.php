...
$topbar_user_role       = isset( $topbar_user['role'] ) ? $topbar_user['role'] : esc_html__( 'Administrator', 'dap' );
...
<div class="dap-admin">
    <header class="dap-topbar shadow-sm mb-4">
        <div class="container-fluid topbar-menu d-flex align-items-center justify-content-between gap-3 py-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-none d-xl-flex flex-column">
                    <span class="fw-semibold text-uppercase small text-muted"><?php echo esc_html__( 'Dashboard', 'dap' ); ?></span>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <button class="btn btn-icon btn-soft-secondary" type="button" data-action="dap-toggle-theme" aria-pressed="false">
    ...
    <div class="offcanvas offcanvas-end dap-customizer-offcanvas" tabindex="-1" id="dapCustomizer" aria-labelledby="dapCustomizerLabel">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title" id="dapCustomizerLabel"><?php echo esc_html__( 'Dashboard Customizer', 'dap' ); ?></h5>
    ...
    <div class="dap-dashboard container-fluid px-3 px-md-4 pb-5">
        ...
        <div class="row g-4 mb-4">
            <div class="col-12">
                <div class="card dap-hero overflow-hidden text-white position-relative">
                    <div class="card-body p-4 p-lg-5">
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-7 col-xxl-8">
                                <div class="dap-hero-copy pe-lg-5">
                                    <span class="badge bg-soft-light text-uppercase text-white-50 fw-semibold mb-3"><?php echo esc_html__( 'Live Overview', 'dap' ); ?></span>
                                    ...
                                    <?php if ( $hero_headline ) : ?>
                                        <div class="d-flex flex-wrap align-items-center gap-3 mb-3">
                                            <h1 class="fw-semibold mb-0 display-5"><?php echo esc_html( $hero_headline['value'] ); ?></h1>
                            ...
                            <div class="col-lg-5 col-xxl-4 text-center text-lg-end">
                                ...
                                <div class="sidenav-user card mt-4 text-start">
                                    <div class="card-body d-flex align-items-center gap-3">
                                        <img src="<?php echo esc_url( $topbar_user_avatar ); ?>" alt="<?php echo esc_attr( $topbar_user_name ); ?>" class="rounded-circle" width="56" height="56" />
                                        <div>
                                            <h5 class="mb-0 fw-semibold"><?php echo esc_html( $topbar_user_name ); ?></h5>
                                            <small class="text-muted"><?php echo esc_html( $topbar_user_role ); ?></small>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-transparent d-flex flex-wrap gap-2 pt-0 border-0">
                                        <a class="btn btn-soft-primary btn-sm" href="<?php echo esc_url( $topbar_profile_url ); ?>"><?php echo esc_html__( 'Gerenciar perfil', 'dap' ); ?></a>
                                        <?php if ( ! empty( $elementor_cta ) ) : ?>
                                            <a class="btn btn-soft-secondary btn-sm" href="<?php echo esc_url( $elementor_cta ); ?>"><?php echo esc_html__( 'Widgets Elementor', 'dap' ); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
        ...
        <?php if ( ! empty( $sales_cards ) ) : ?>
            <div class="row g-4 mb-4">
                <?php foreach ( $sales_cards as $card ) : ?>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card dap-sales-card h-100">
                            <div class="card-body d-flex align-items-center gap-3">
        ...
        <div class="row g-4 mb-4">
            <div class="col-12 col-xl-8">
                <div class="card dap-sales-analytics h-100">
                    <div class="card-header border-0 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                        <div>
                            <p class="text-muted mb-1 text-uppercase small fw-semibold"><?php echo esc_html__( 'Sales Analytics', 'dap' ); ?></p>
                            <h2 class="fw-semibold mb-0"><?php echo esc_html__( 'Performance Overview', 'dap' ); ?></h2>
                            <p class="text-muted mb-0"><?php echo esc_html__( 'Acompanhe vendas por período e ajuste squads rapidamente.', 'dap' ); ?></p>
                        </div>
                        <div class="btn-group dap-sales-analytics-filter mt-3 mt-md-0" role="group" aria-label="<?php esc_attr_e( 'Filtro de intervalo', 'dap' ); ?>">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-12 col-xl-5">
                <div class="card dap-orders h-100">
                    <div class="card-header border-0 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                        <div>
                            <h4 class="card-title mb-1"><?php echo esc_html__( 'Recent Orders', 'dap' ); ?></h4>
