...
<div class="dap-admin">
    ...
    <div class="dap-dashboard container-fluid px-3 px-md-4 pb-5">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-7 col-xxl-8">
                                <div class="dap-hero-copy pe-lg-5">
                                    ...
                                    <?php else : ?>
                                        <h1 class="fw-semibold mb-3"><?php echo esc_html__( 'Centro de Controle Privilege', 'dap' ); ?></h1>
        ...
        <?php if ( ! empty( $sales_cards ) ) : ?>
            <div class="row g-4 mb-4" data-dap-grid="sales-cards">
        ...
        <?php endif; ?>
        <div class="row g-4 mb-4" data-dap-grid="kpis">
            <?php if ( ! empty( $kpis ) ) : ?>
        ...
        <div class="row g-4 mb-4" data-dap-grid="charts">
        ...
        <div class="row g-4 mb-4" data-dap-grid="tables">
        ...
        <div class="row g-4 mb-4" data-dap-grid="projects">
            <div class="col-12 col-xl-4">
        ...
        <div class="row g-4 mb-4" data-dap-grid="logs">
        ...
        <div class="row g-4" data-dap-grid="activity">
            <div class="col-12 col-xl-7">
                <div class="card h-100">
                    <div class="card-header border-0">
