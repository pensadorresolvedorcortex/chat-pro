    ...
    protected function render() {
        ...
        if ( $query->have_posts() ) {
            ...
            if ( ! is_wp_error( $filter_terms ) && ! empty( $filter_terms ) ) {
                ...
                echo '<button class="active" data-term="all">' . esc_html__( 'All', 'housi-portfolio' ) . '</button>';
            ...
            while ( $query->have_posts() ) {
                ...
                if ( has_post_thumbnail() ) {
                    ...
                    echo '<div class="housi-portfolio-overlay"><h3 class="housi-portfolio-title">' . esc_html( get_the_title() ) . '</h3></div>';
                    echo '</a></div>';
                } else {
