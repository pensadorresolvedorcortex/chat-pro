...
<?php if ( have_posts() ) : ?>
    ...
    if ( ! is_wp_error( $terms ) && ! empty( $terms ) ) : ?>
        <div class="housi-portfolio-filters">
            <button class="active" data-term="all"><?php esc_html_e( 'All', 'housi-portfolio' ); ?></button>
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="housi-portfolio-item<?php echo esc_attr( $term_classes ); ?>">
            <?php if ( has_post_thumbnail() ) : ?>
                <div class="housi-portfolio-thumb"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'large' ); ?><div class="housi-portfolio-overlay"><h3 class="housi-portfolio-title"><?php the_title(); ?></h3></div></a></div>
            <?php else : ?>
