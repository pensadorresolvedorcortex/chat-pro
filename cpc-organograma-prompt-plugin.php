...
.cpc-home-wrap{position:relative;border-radius:40px;background:linear-gradient(135deg, {$primary} 0%, {$secondary} 100%);padding:18px;box-shadow:0 30px 80px rgba(106,90,224,.38);overflow:hidden}
.cpc-home-wrap::before{content:"";position:absolute;inset:0;background:radial-gradient(circle at top right, rgba(255,255,255,.4), transparent 55%);pointer-events:none}
.cpc-home-panel{position:relative;z-index:1;border-radius:32px;padding:48px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.4);backdrop-filter:blur(30px);display:flex;flex-direction:column;gap:40px;box-shadow:0 24px 60px rgba(15,23,42,.22)}
...
.cpc-home-actions .cpc-bell{width:52px;height:52px;background:rgba(255,255,255,.18);border:1px solid rgba(255,255,255,.55);color:#fff;box-shadow:0 14px 34px rgba(15,23,42,.25)}
.cpc-home-actions .cpc-bell:hover{transform:translateY(-2px);background:rgba(255,255,255,.28)}
.cpc-home-actions .cpc-bell-panel{background:rgba(14,23,52,.92);border:1px solid rgba(255,255,255,.25);color:#f8f9ff;backdrop-filter:blur(24px)}
...
.cpc-home-user-toggle{display:flex;align-items:center;gap:14px;padding:6px 18px 6px 6px;border-radius:999px;border:1px solid rgba(255,255,255,.55);background:rgba(255,255,255,.18);color:#fff;font-weight:600;cursor:pointer;transition:background .2s ease,box-shadow .2s ease}
.cpc-home-user-toggle:hover,.cpc-home-user-toggle:focus-visible{background:rgba(255,255,255,.28);box-shadow:0 18px 38px rgba(15,23,42,.25);outline:none}
...
.cpc-home-menu{position:absolute;top:calc(100% + 14px);right:0;min-width:220px;border-radius:22px;padding:12px 0;background:rgba(14,23,52,.92);border:1px solid rgba(255,255,255,.22);box-shadow:0 28px 60px rgba(15,23,42,.35);backdrop-filter:blur(22px);display:none;z-index:40}
...
.cpc-home-menu a:hover{background:rgba(255,255,255,.08)}
.cpc-home-body{display:grid;grid-template-columns:1fr;gap:28px}
.cpc-home-highlight{display:flex;flex-direction:column;gap:20px;background:rgba(255,255,255,.12);border-radius:28px;padding:28px;border:1px solid rgba(255,255,255,.32);box-shadow:0 20px 50px rgba(15,23,42,.22)}
.cpc-home-highlight-note{margin:0;font-size:.95rem;color:rgba(255,255,255,.78)}
.cpc-home-latest{padding:20px 22px;border-radius:22px;background:rgba(15,23,42,.28);border:1px solid rgba(255,255,255,.28);display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap}
.cpc-home-latest.has-unread{border-color:rgba(255,255,255,.45)}
...
.cpc-home-card{background:rgba(255,255,255,.16);border-radius:26px;padding:24px;border:1px solid rgba(255,255,255,.35);box-shadow:0 18px 44px rgba(15,23,42,.24);transition:transform .2s ease,box-shadow .2s ease;background-clip:padding-box}
.cpc-home-card a{color:#fff;text-decoration:none;display:flex;flex-direction:column;gap:14px;height:100%}
.cpc-home-card:hover{transform:translateY(-4px);box-shadow:0 24px 60px rgba(15,23,42,.28)}
.cpc-home-card-label{font-size:1.1rem;font-weight:700;margin:0}
.cpc-home-card-text{margin:0;font-size:.95rem;line-height:1.6;color:rgba(255,255,255,.78)}
.cpc-home-card-action{margin-top:auto;font-weight:600;font-size:.9rem;color:rgba(255,255,255,.85)}
