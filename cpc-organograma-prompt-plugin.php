...
.cpc-home-area{font-family:"Inter",sans-serif;max-width:960px;margin:0 auto;padding:48px 24px;color:#fff;position:relative}
.cpc-home-wrap{position:relative;border-radius:34px;background:linear-gradient(140deg, {$home_primary} 0%, {$home_secondary} 100%);padding:18px;border:1px solid rgba(255,255,255,.32);box-shadow:0 32px 70px rgba(255,60,172,.4);overflow:hidden}
.cpc-home-wrap::before{content:"";position:absolute;inset:0;background:radial-gradient(circle at top right, rgba(255,255,255,.4), transparent 62%),radial-gradient(circle at bottom left, rgba(255,130,210,.5), transparent 68%);pointer-events:none}
.cpc-home-panel{position:relative;z-index:1;border-radius:28px;padding:32px;background:linear-gradient(150deg, rgba(255,255,255,.24) 0%, rgba(255,255,255,.08) 100%);border:1px solid rgba(255,255,255,.5);backdrop-filter:blur(28px);display:flex;flex-direction:column;gap:28px;box-shadow:0 22px 56px rgba(42,16,61,.3)}
.cpc-home-header{display:flex;align-items:center;justify-content:space-between;gap:24px;flex-wrap:wrap}
.cpc-home-greeting{display:flex;flex-direction:column;gap:6px}
.cpc-home-welcome{font-size:.8rem;font-weight:700;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.8)}
.cpc-home-name{margin:0;font-size:1.9rem;font-weight:700;line-height:1.1;color:#fff}
.cpc-home-actions{display:flex;align-items:center;gap:12px;flex-wrap:wrap;position:relative}
.cpc-home-actions .cpc-bell{width:46px;height:46px;background:rgba(255,255,255,.2);border:1px solid rgba(255,255,255,.7);color:#fff;box-shadow:0 16px 34px rgba(42,16,61,.36)}
...
.cpc-home-user{display:flex;align-items:center;gap:10px;padding:6px 14px;border-radius:999px;border:1px solid rgba(255,255,255,.7);background:rgba(255,255,255,.22);color:#fff;font-weight:600}
.cpc-home-avatar{width:46px;height:46px;border-radius:18px;overflow:hidden;border:2px solid rgba(255,255,255,.85);box-shadow:0 10px 22px rgba(15,23,42,.22);flex-shrink:0}
.cpc-home-avatar img{width:100%;height:100%;object-fit:cover}
.cpc-home-caret{width:10px;height:10px;border-left:2px solid currentColor;border-bottom:2px solid currentColor;transform:rotate(-45deg);margin-left:2px}
.cpc-home-body{display:grid;grid-template-columns:1fr;gap:22px}
.cpc-home-highlight{display:flex;flex-direction:column;gap:16px;background:rgba(255,63,172,.18);border-radius:24px;padding:22px;border:1px solid rgba(255,255,255,.38);box-shadow:0 20px 48px rgba(42,16,61,.28)}
.cpc-home-highlight-note{margin:0;font-size:.9rem;color:rgba(255,255,255,.82)}
.cpc-home-latest{padding:16px 18px;border-radius:18px;background:rgba(42,16,61,.32);border:1px solid rgba(255,255,255,.38);display:flex;align-items:flex-start;justify-content:space-between;gap:14px;flex-wrap:wrap}
.cpc-home-latest-info{display:flex;flex-direction:column;gap:6px;max-width:520px}
.cpc-home-latest-label{font-size:.78rem;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.72)}
.cpc-home-highlight-title{margin:0;font-size:1.05rem;font-weight:600;color:#fff}
.cpc-home-latest-time{font-size:.82rem;color:rgba(255,255,255,.68)}
.cpc-home-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:18px}
.cpc-home-card{position:relative;overflow:hidden;border-radius:22px;padding:20px;background:linear-gradient(160deg, rgba(255,255,255,.26) 0%, rgba(255,255,255,.08) 100%);border:1px solid rgba(255,255,255,.5);box-shadow:0 20px 50px rgba(42,16,61,.28)}
.cpc-home-card a{position:relative;z-index:1;color:#fff;text-decoration:none;display:flex;flex-direction:column;gap:12px;height:100%}
.cpc-home-card-label{font-size:1rem;font-weight:700;margin:0}
.cpc-home-card-action{margin-top:auto;font-weight:600;font-size:.88rem;color:rgba(255,255,255,.86)}
@media(max-width:880px){.cpc-home-panel{padding:28px}.cpc-home-name{font-size:1.75rem}}
@media(max-width:640px){.cpc-home-area{padding:40px 18px}.cpc-home-panel{padding:24px}.cpc-home-actions{width:100%;justify-content:flex-start}.cpc-home-user{padding:6px 12px}}
                    ...
                    <div class="cpc-home-panel">
                        <header class="cpc-home-header">
                            ...
                            <div class="cpc-home-actions">
                                ...
                                <div class="cpc-home-user" aria-label="<?php esc_attr_e('Perfil do usuário', 'cpc-login-academia'); ?>">
