...
$lf_form_i18n = array(
	'multichoiceTip'       => sprintf(esc_attr__( 'Faça sua Escolha e %s Pressione Enter %s', 'lastform' ), '<strong>', '</strong>'),
	'multichoiceTipMobile' => esc_attr__( 'Escolha', 'lastform' ),
	'hintKey'              => esc_attr_x( 'Tecla', 'Tecla do Teclado','lastform' ),
	'textareaTip'           => sprintf( esc_attr__( 'Para adicionar um parágrafo, Pressione %s Shift + Enter %s', 'lastform' ), '<strong>', '</strong>'),
	'uploadButton'         => esc_attr__( 'Carregar', 'lastform' ),
	'allowedExtensions'    => esc_attr__( 'Allowed file extensions:', 'lastform' ),
	'rejectedFiles'        => esc_attr__( 'Rejected files:', 'lastform' ),
	'pressEnter'           => sprintf(esc_attr__( 'Pressione Enter', 'lastform' ), '<strong>', '</strong>'),
	'checkboxTip'          => esc_html__('Escolha sua Resposta' , 'lastform'),
	'multiselectTip'       => sprintf( esc_attr__( 'Pressione %s Shift + Enter %s e escolha', 'lastform' ), '<strong>', '</strong>'),
	'progressPercentage'   => esc_attr__('$1 completo', 'lastform'),
	'progressProportional' => esc_attr__('$1 de $2 respondidas', 'lastform'),
	'pageProgress'         => esc_attr__('Passo $1 de $2', 'lastform'),
	'submit'               => esc_attr__('Enviar', 'lastform'),
	'sendEmail'            => esc_attr__('Enviar Email', 'lastform'),
	'selectFile'           => esc_attr__( 'Selecionar Arquivo', 'gravityforms' ),
	'selectFiles'          => esc_attr__( 'Selecionar Arquivo', 'gravityforms' ),
	'dropFilesHere'        => esc_html__( 'Solte arquivos aqui ou', 'gravityforms' ),
	'today'                => esc_html__( 'Hoje', 'gravityforms' ),
	'or'                   => esc_attr__('ou', 'lastform'),
	'prev'                 => esc_attr__('Anterior', 'lastform'),
	'next'                 => esc_attr__('Próximo', 'lastform'),
	'select'               => esc_attr__('Selecione', 'lastform'),
	'yes'                  => esc_attr__( 'Sim', 'gravityforms' ),
	'no'                   => esc_attr__( 'Não', 'gravityforms' ),
	'price'                => esc_html__( 'Preço', 'gravityforms' ),
	'quantity'             => esc_html__( 'Quantidade', 'gravityforms' ),
);

$lf_form_i18n['errors'] = array(
	'reviewIsNeeded'     => esc_attr__('Alguns campos precisam ser revistos.', 'lastform'),
	'required'           => esc_attr__('Você esqueceu de preencher este campo.', 'lastform'),
	'reviewFields'       => esc_attr__('Ops! Existe algum erro!', 'lastform'),
	'noDuplicates'       => esc_attr__('Já existe.', 'lastform'),
...
if ($lf_form['lastform']['soundEffectsEnabled']) {
        $lf_global['effects'] = array(
                'type' => 'std',
                // Sound effects audio removed to avoid binary assets.
                'mp3'  => ''
        );
}
