...
$x_months = "['".__('Jan','gdwlang')."', '".__('Feb','gdwlang')."', '".__('Mar','gdwlang')."','".__('Apr','gdwlang')."', '".__('May','gdwlang')."', '".__('Jun','gdwlang')."', '".__('Jul','gdwlang')."', '".__('Aug','gdwlang')."', '".__('Sep','gdwlang')."', '".__('Oct','gdwlang')."', '".__('Nov','gdwlang')."', '".__('Dec','gdwlang')."']";
...
?>   
            <div class="chartBox"><?php //print_r($monthsArray); ?>
                <h4 class='widhead'><?php echo __("Comments By Months in Each Year","gdwlang"); ?></h4>
                <div id="gdw_comments_byMonthYear" style='height:180px;'></div>
            </div>

            <script type="text/javascript">
                    // Initialize after dom ready
                    var myChart2 = echarts.init(document.getElementById('gdw_comments_byMonthYear')); 
                                ...
                                feature : {
                                    ...
                                    magicType : {
                                      ...
                                      title : {
                                          ...
                                          stack : '<?php echo __("Stacked Bar","gdwlang"); ?>',
                                          tiled : '<?php echo __("Tiled Bar","gdwlang"); ?>'
                                      },
                    ...
                    //window.onresize = echarts.init(document.getElementById('gdw_comments_byMonthYear')).resize;
...
if(sizeof($yearWiseArray) > 0){
      ...
      //   echo "". $x_years." ".$y_total; ?>
            ...
            <br><br><div class="chartBox"><?php //print_r($yearWiseArray); ?>
                <h4 class='widhead'><?php echo __("Comments By Year","gdwlang"); ?></h4>
                <div id="gdw_comments_byYear" style='height:180px;'></div>
            </div>


            <script type="text/javascript">
                    // Initialize after dom ready
                   var myChart3 = echarts.init(document.getElementById('gdw_comments_byYear')); 
                    ...
                    itemGap: 10,
                            ...
                            series: [
                                {
                                    name: '<?php echo __("Comments","gdwlang"); ?>',
                                    type: 'line',
                                    smooth: true,
                                    symbol:'none',
                                    symbolSize:2,
...
<?php } ?>
        ...
        <?php if(is_array($totalComments) && sizeof($totalComments) > 0){ 
           ...
           // if(isset($usersCount['avail_roles']) && sizeof($usersCount['avail_roles']) > 0){
                foreach ($totalComments as $key => $value) {
                    ...
                    if($key == "post-trashed"){ $key = __("Trashed with Post","gdwlang"); }
                    if($key == "moderated"){ $key = __("Pending","gdwlang"); }
           ...
           // }
        ?>
            <br><br><div class="chartBox"><?php //print_r($totalComments); echo "Total Comments: ". $totalComments->total_comments; ?>
                  <h4 class='widhead'><?php echo __("Comments Count and Type","gdwlang"); ?></h4>
            ...
            <script type="text/javascript">
              ...
              var option_commentwise = {
                color: ['<?php echo $getcolor[0]; ?>','<?php echo $getcolor[1]; ?>','<?php echo $getcolor[2]; ?>','<?php echo $getcolor[3]; ?>','<?php echo $getcolor[4]; ?>','<?php echo $getcolor[5]; ?>'],
                    ...
                    series : [
                        {
                            name:'<?php echo __("Comments Count","gdwlang"); ?>',
                            type:'pie',
                            radius : [20, '80%'],
                            roseType : 'radius',
                            center: ['50%', '45%'],
