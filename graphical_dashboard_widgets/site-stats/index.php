...
/*Dashboard Widget GRUPOS*/

function gdw_groups_add_dashboard() {
  wp_add_dashboard_widget( 'gdw_groups_wp_dashboard', __('GRUPOS', 'gdwlang'), 'gdw_groups_dashboard_output' );
}

function gdw_groups_dashboard_output() {
  include('includes/gdw-groups-card.php');
}
