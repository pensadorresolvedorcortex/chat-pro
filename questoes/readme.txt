...
Para listar conteúdos em andamento de cada usuário, exibindo sessões de questões e cursos com retomada rápida, utilize `[questoes_meus_conhecimentos titulo="Meus conhecimentos" descricao="Retome rapidamente seus estudos"]` (opcional: personalize o aviso para visitantes com `mensagem_login="Faça login para sincronizar seu progresso."`).
...
= 0.14.1 =
* Permite personalizar a mensagem exibida para visitantes no painel `[questoes_meus_conhecimentos]` e inclui aviso estilizado quando o login é necessário para sincronizar o progresso.
