...
function questoes_render_course_card( $course, $args = array() ) {
    ...
    <article class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $classes ) ) ); ?>" data-region="<?php echo esc_attr( $region ); ?>" data-count="<?php echo esc_attr( $count ); ?>" data-priority="<?php echo esc_attr( isset( $course['priority'] ) ? (int) $course['priority'] : 0 ); ?>">
        <div class="questoes-course-card__inner">
            ...
            <?php if ( $highlight ) : ?>
                <p class="questoes-course-card__subtitle"><?php echo $highlight; ?></p>
            <?php endif; ?>

            <div class="questoes-course-card__body">
                <div class="questoes-course-card__details">
                    <?php if ( $salary ) : ?>
                        <div class="questoes-course-card__detail">
                            <span class="questoes-course-card__detail-label"><?php esc_html_e( 'Remuneração', 'questoes' ); ?></span>
                            <span class="questoes-course-card__detail-value"><?php echo esc_html( $salary ); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if ( $opps ) : ?>
                        <div class="questoes-course-card__detail">
                            <span class="questoes-course-card__detail-label"><?php esc_html_e( 'Vagas', 'questoes' ); ?></span>
                            <span class="questoes-course-card__detail-value"><?php echo esc_html( $opps ); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <footer class="questoes-course-card__footer">
                <div class="questoes-course-card__metrics" aria-label="<?php esc_attr_e( 'Resumo do curso', 'questoes' ); ?>">
                    <span class="questoes-course-card__metric">
