    ...
    <article class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $classes ) ) ); ?>" data-count="<?php echo esc_attr( $count ); ?>" data-priority="<?php echo esc_attr( isset( $course['priority'] ) ? (int) $course['priority'] : 0 ); ?>">
        <div class="questoes-course-card__inner">
            ...
            <div class="questoes-course-card__details">
                ...
                <?php if ( $salary ) : ?>
                    <p class="questoes-course-card__stat">
                        <span><?php esc_html_e( 'Salários a partir de', 'questoes' ); ?></span>
                ...
                <?php if ( $opps ) : ?>
                    <p class="questoes-course-card__stat">
                        <span><?php esc_html_e( 'Oportunidades', 'questoes' ); ?></span>
                        <strong><?php echo esc_html( $opps ); ?></strong>
                    </p>
                <?php endif; ?>

                <p class="questoes-course-card__stat">
                    <span><?php esc_html_e( 'Questões no banco', 'questoes' ); ?></span>
