...
function questoes_render_question_card( $question ) {
    ...
    <article class="questoes-question-card" data-question-id="<?php echo esc_attr( $question['id'] ); ?>">
        ...
        <?php if ( $has_answers ) : ?>
            <button type="button" class="questoes-question-card__toggle" data-action="toggle-answer" aria-expanded="false" aria-controls="<?php echo esc_attr( $answers_id ); ?>"><?php esc_html_e( 'Mostrar alternativas', 'questoes' ); ?></button>
