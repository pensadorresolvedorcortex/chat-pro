            ...
            <form method="post" action="options.php" enctype="multipart/form-data">
                ...
                <div class="questoes-card">
                    ...
                    <ul class="questoes-shortcode-list">
                        ...
                        <li>
                            <code>[questoes_em_alta titulo="Em alta agora" limite_questoes="6" limite_cursos="6"]</code>
                            <span><?php esc_html_e( 'Apresenta os itens mais acessados do banco: questões, cursos e disciplinas com estatísticas atualizadas.', 'questoes' ); ?></span>
                        </li>
                        <li>
                            <code>[questoes_meus_conhecimentos titulo="Meus conhecimentos" descricao="Retome seus estudos"]</code>
                            <span><?php esc_html_e( 'Exibe o painel pessoal com os cursos e conjuntos de questões iniciados para continuar depois.', 'questoes' ); ?></span>
                        </li>
                        <li>
