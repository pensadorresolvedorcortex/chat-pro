            ...
            <form method="post" action="options.php" enctype="multipart/form-data">
                ...
                <div class="questoes-card">
                    ...
                    <ul class="questoes-shortcode-list">
                        ...
                        <li>
                            <code>[questoes_cursos titulo_destaques="Cursos em alta" titulo_regioes="Cursos por região"]</code>
                            <span><?php esc_html_e( 'Apresenta a vitrine de cursos com destaques ordenáveis, resumo numérico e filtro regional antes de carregar as questões relacionadas.', 'questoes' ); ?></span>
                        </li>
                    </ul>
