...
class Questoes_Frontend {
    ...
    public function __construct( Questoes_Settings $settings, Questoes_Renderer $renderer, Questoes_Accessibility $accessibility, Questoes_Questions $questions, Questoes_Courses $courses ) {
