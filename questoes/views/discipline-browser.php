...
<div class="questoes-stage questoes-discipline-browser" data-component="discipline-browser">
    <div class="questoes-shell questoes-shell--wide">
        <header class="questoes-hero questoes-discipline-browser__hero">
            <div class="questoes-hero__content">
                <span class="questoes-hero__eyebrow"><?php esc_html_e( 'Mapa de disciplinas', 'questoes' ); ?></span>
            ...
            <div class="questoes-hero__stats">
                <div class="questoes-hero__stat">
                    <span class="questoes-hero__stat-label"><?php esc_html_e( 'Disciplinas catalogadas', 'questoes' ); ?></span>
                    <span class="questoes-hero__stat-value"><?php echo esc_html( number_format_i18n( $total_disciplines ) ); ?></span>
                </div>
                <div class="questoes-hero__stat">
                    <span class="questoes-hero__stat-label"><?php esc_html_e( 'Áreas de formação', 'questoes' ); ?></span>
                    <span class="questoes-hero__stat-value"><?php echo esc_html( number_format_i18n( $total_areas ) ); ?></span>
                </div>
                <div class="questoes-hero__stat">
                ...
                <div class="questoes-hero__stat">
                    <span class="questoes-hero__stat-label"><?php esc_html_e( 'Comentários publicados', 'questoes' ); ?></span>
                    <span class="questoes-hero__stat-value"><?php echo esc_html( number_format_i18n( $total_comments ) ); ?></span>
                </div>
            </div>
