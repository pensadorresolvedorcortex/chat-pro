...
$knowledge_seed    = $hero_title . '|' . $host_slug;
$knowledge_key     = 'bank-' . substr( md5( $knowledge_seed ), 0, 12 );
...
?>
<div class="questoes-stage questoes-question-bank" data-config="<?php echo esc_attr( wp_json_encode( $config ) ); ?>" data-knowledge-key="<?php echo esc_attr( $knowledge_key ); ?>" data-title="<?php echo esc_attr( $hero_title ); ?>">
