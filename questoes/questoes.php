...
require_once QUESTOES_PLUGIN_DIR . 'includes/class-courses.php';
require_once QUESTOES_PLUGIN_DIR . 'includes/class-knowledge.php';
...
function questoes_bootstrap() {
    ...
    $courses       = new Questoes_Courses();
    $questions     = new Questoes_Questions();
    $renderer      = new Questoes_Renderer( $settings );
    $accessibility = new Questoes_Accessibility();
    $knowledge     = new Questoes_Knowledge();

    new Questoes_Admin( $settings, $renderer, $courses );
    new Questoes_Frontend( $settings, $renderer, $accessibility, $questions, $courses, $knowledge );
    new Questoes_REST( $settings, $renderer, $questions, $knowledge );
