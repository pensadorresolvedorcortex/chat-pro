...
- **WhatsApp Chat Module**: plugin Perfex localizado em `modules/whatsapp_chat/` que adiciona um botão de contato via WhatsApp nas áreas do cliente e de administração do CRM.
