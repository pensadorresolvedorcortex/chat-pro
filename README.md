...
Este repositório inclui a versão final do plugin **Bolao X** totalmente funcional.
Todos os recursos listados abaixo estão disponíveis na release 3.13.0.


## Plugins

 - **Bolao X** (v3.13.0): plugin WordPress localizado em `bolao-x/`.
   Principais recursos:
