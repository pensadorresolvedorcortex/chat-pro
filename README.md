...
Um tema neon já acompanha o plugin e é carregado automaticamente no painel do WordPress (dashboard e página de configurações),
 estilizando os widgets e formulários com gradientes, brilhos e tipografia premium.
