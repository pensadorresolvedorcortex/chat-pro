...
## Plugins
 ...
 - **Bolao X** (v3.11.6): plugin WordPress localizado em `bolao-x/`.
   Principais recursos:
  ...
  - Após login ou cadastro o usuário é redirecionado para a página /participe
   ...
   - Shortcode `[bolao_x_dashboard]` exibe um painel com ícones para acessar
     apostas, resultados, estatísticas, perfil e logout
