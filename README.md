...
- Card extra **GRUPOS** (1580×370) abre `/admin.php?page=juntaplay-groups`, traz valores recebidos no mês, avatares de novos usuários, grupos pendentes com miniaturas e as 5 transações mais recentes (dados de WooCommerce quando disponível) com selo visual `dheniell.svg` no canto. Inclui botão **Atualizar** para reconsultar os dados via Ajax sem recarregar o painel.
