...
// Don't duplicate me!
if ( !class_exists ( 'RedukFramework_checkbox' ) ) {

    /**
     * Main RedukFramework_checkbox class
     *
     * @since       1.0.0
     */
    class RedukFramework_checkbox {
        protected $parent;
        protected $field;
        protected $value;
        ...
        public function enqueue () {
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style (
                    'reduk-field-checkbox-css',
                    RedukFramework::$_url . 'inc/fields/checkbox/field_checkbox.css',
                    array(),
                    time (),
                    'all'
                );
            ...
            wp_enqueue_script (
                'reduk-field-checkbox-js',
                RedukFramework::$_url . 'inc/fields/checkbox/field_checkbox' . Reduk_Functions::isMin () . '.js',
