...
// Don't duplicate me!
    if ( ! class_exists( 'RedukFramework_ace_editor' ) ) {
        class RedukFramework_ace_editor {
            protected $parent;
            protected $field;
            protected $value;
            ...
            public function enqueue() {
                if ( $this->parent->args['dev_mode'] ) {
                    if ( ! wp_style_is( 'reduk-field-ace-editor-css' ) ) {
                        wp_enqueue_style(
                            'reduk-field-ace-editor-css',
                            RedukFramework::$_url . 'inc/fields/ace_editor/field_ace_editor.css',
                            array(),
                            time(),
                            'all'
                        );
                ...
                if ( ! wp_script_is( 'reduk-field-ace-editor-js' ) ) {
                    wp_enqueue_script(
                        'reduk-field-ace-editor-js',
                        RedukFramework::$_url . 'inc/fields/ace_editor/field_ace_editor' . Reduk_Functions::isMin() . '.js',
                        array( 'jquery', 'ace-editor-js', 'reduk-js' ),
                        time(),
                        true
                    );
                }
