...
// Don't duplicate me!
if ( ! class_exists( 'RedukFramework_media' ) ) {

    /**
     * Main RedukFramework_media class
     *
     * @since       1.0.0
     */
    class RedukFramework_media {
        protected $parent;
        protected $field;
        protected $value;
        ...
        public function render() {
            ...
            echo '<img class="reduk-option-image" id="image_' . $this->field['id'] . '" src="' . $this->value['thumbnail'] . '" alt="" target="_blank" rel="external" />';
            echo '</a>';
            echo '</div>';
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'mtrl_framework' ) . '</span>';
            ...
            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'mtrl_framework' ) . '</span>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'reduk-field-media-js',
                RedukFramework::$_url . 'assets/js/media/media' . Reduk_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style('reduk-field-media-css');
            }
        }
    }
}
