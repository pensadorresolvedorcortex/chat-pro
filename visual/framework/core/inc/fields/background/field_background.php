...
// Don't duplicate me!
    if ( ! class_exists( 'RedukFramework_background' ) ) {

        /**
         * Main RedukFramework_background class
         *
         * @since       3.1.5
         */
        class RedukFramework_background {
            protected $parent;
            protected $field;
            protected $value;
            ...
            public function render() {
                ...
                if ( $this->field['background-color'] === true ) {
                    ...
                    echo '<input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-color]" id="' . $this->field['id'] . '-color" class="reduk-color reduk-background-input reduk-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['background-color'] . '"  data-default-color="' . ( isset( $this->field['default']['background-color'] ) ? $this->field['default']['background-color'] : "" ) . '" />';
                    ...
                    if ( ! isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                        ...
                        echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency reduk-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="' . $this->field['id'] . '-color" value="1"' . $tChecked . '> ' . __( 'Transparent', 'mtrl_framework' ) . '</label>';
                    }
                ...
                if ( $this->field['background-repeat'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Repeat', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-repeat]" class="reduk-select-item reduk-background-input reduk-background-repeat ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-clip'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Clip', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-clip]" class="reduk-select-item reduk-background-input reduk-background-clip ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-origin'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Origin', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-origin]" class="reduk-select-item reduk-background-input reduk-background-origin ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-size'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Size', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-size]" class="reduk-select-item reduk-background-input reduk-background-size ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-attachment'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-attachment-select" data-placeholder="' . __( 'Background Attachment', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-attachment]" class="reduk-select-item reduk-background-input reduk-background-attachment ' . $this->field['class'] . '">';
                    echo '<option></option>';
                    foreach ( $array as $k => $v ) {
                ...
                if ( $this->field['background-position'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-position-select" data-placeholder="' . __( 'Background Position', 'mtrl_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-position]" class="reduk-select-item reduk-background-input reduk-background-position ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    $placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : __( 'No media selected', 'mtrl_framework' );

                    echo '<input placeholder="' . $placeholder . '" type="text" class="reduk-background-input ' . $hide . 'upload ' . $this->field['class'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-image]" id="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][background-image]" value="' . $this->value['background-image'] . '" />';
                    ...
                    echo '<img class="reduk-option-image" id="image_' . $this->value['media']['id'] . '" src="' . $this->value['media']['thumbnail'] . '" alt="" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';
                    ...
                    echo '<span class="button reduk-background-upload" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'mtrl_framework' ) . '</span>';
                    ...
                    echo '<span class="button removeCSS reduk-remove-background' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'mtrl_framework' ) . '</span>';
            ...
            public function enqueue() {
                ...
                if (!wp_script_is ( 'reduk-field-background-js' )) {
                    wp_enqueue_script(
                        'reduk-field-background-js',
                        RedukFramework::$_url . 'inc/fields/background/field_background' . Reduk_Functions::isMin() . '.js',
                ...
                if ($this->parent->args['dev_mode']) {
                    if (!wp_style_is ( 'reduk-field-background-css' )) {
                        wp_enqueue_style(
                            'reduk-field-background-css',
                            RedukFramework::$_url . 'inc/fields/background/field_background.css',
                            array(),
                            time(),
                            'all'
                        );
