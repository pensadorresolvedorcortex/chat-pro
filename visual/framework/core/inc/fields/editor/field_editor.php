...
// Don't duplicate me!
if ( ! class_exists( 'RedukFramework_editor' ) ) {

    /**
     * Main RedukFramework_editor class
     *
     * @since       1.0.0
     */
    class RedukFramework_editor {
        protected $parent;
        protected $field;
        protected $value;
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-editor-css',
                    RedukFramework::$_url . 'inc/fields/editor/field_editor.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'reduk-field-editor-js',
                RedukFramework::$_url . 'inc/fields/editor/field_editor' . Reduk_Functions::isMin() . '.js',
