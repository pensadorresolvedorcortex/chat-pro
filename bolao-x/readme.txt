...
* Confirmação automática via webhook assinado (segredo configurável no admin)
...
4. Defina um segredo para o webhook caso utilize a confirmação automática de pagamentos.
5. Posicione o shortcode `[bolao_x_form]` em uma página para receber apostas.
...
== Changelog ==
= 3.11.1 =
* Espaço maior entre o resultado e a lista de números repetidos
* Círculos das dezenas nas apostas agora usam o mesmo tamanho do quadro de resultado
* Linha "Menos Pontos" destacada e posicionada ao final da tabela
= 3.11.0 =
