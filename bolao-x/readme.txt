...
* Horários limite configuráveis para novos cadastros
* Pagamento via Pix com QR Code
* Confirmação automática via webhook (token definido no código)
* Chave Pix pode ser alterada a qualquer momento pelo administrador
...
* Widget de resumo no painel e envio de e-mails automáticos
