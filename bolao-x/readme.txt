...
== Changelog ==
= 2.8.80 =
* Ajusta contagem de acertos considerando dezenas repetidas
= 2.8.79 =
* Recarrega a página caso o AJAX de "Minhas Apostas" falhe ao filtrar concursos
= 2.8.78 =
* Corrige o filtro de concursos em "Minhas Apostas" sem exigir recarregar a página
= 2.8.77 =
* Mantém apostas de concursos anteriores para consulta no dashboard e frontend
* Filtros listam apenas concursos com resultados publicados
= 2.8.76 =
* Listas de concursos em "Minhas Apostas" e "Contemplados" exibem sempre os 15 mais recentes
= 2.8.75 =
* Apostas são salvas com as dezenas ordenadas em ordem crescente
= 2.8.74 =
* Resultados aceitam até 50 dezenas editáveis
= 2.8.73 =
* Permite salvar até 100 dezenas em resultados e mantém o campo editável
= 2.8.72 =
* Recalcula as apostas ao editar resultados já publicados e garante que as novas dezenas sejam salvas
= 2.8.71 =
* Recalcula as apostas sempre que um resultado publicado é editado
= 2.8.70 =
* Corrige o cálculo das apostas ao salvar resultados e permite editar os números
= 2.8.68 =
* Estatísticas dos concursos exibidas em tabela com legenda de cores
= 2.8.67 =
* Destaque de dezenas repetidas em "Contemplados" é exibido somente para o concurso ativo
= 2.8.66 =
* Ajusta a largura da coluna de porcentagem em "Minhas Apostas" para melhorar a leitura

= 2.8.65 =
* Aumenta a largura da coluna de porcentagem em "Minhas Apostas" para melhor leitura
= 2.8.64 =
* Exibe números de apostas pendentes sem destaque quando não há resultado
* Corrige ação do botão "Pagar agora" após filtrar apostas
= 2.8.63 =
* Corrige destaque de dezenas apenas após a publicação do resultado
* Botão "Pagar agora" abre o modal de Pix em "Minhas Apostas"
= 2.8.62 =
* Exibe apostas não pagas em "Minhas Apostas" para que o apostador possa finalizar o pagamento
= 2.8.61 =
* Remove a lista inferior de dezenas selecionadas e destaca diretamente no quadro
* Números exibem contagem e usam degradê verde
= 2.8.60 =
