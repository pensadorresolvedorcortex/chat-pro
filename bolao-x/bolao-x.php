...
const VERSION = '2.8.80';
    ...
    public function contemplados_page() {
        ...
        if ( isset( $_GET['export_html'] ) ) {
            $this->export_winners_html( $numbers, $selected, get_the_title( $selected ), $order, $prize_values, $prize_winners, $fundo_caixa );
        }
    ...
    private function generate_report( $result, $contest_id = 0, $order_by = 'score', $prizes = array(), $winners = array(), $fund = '' ) {
        ...
        $out .= $this->build_prize_table( $hits10, $hits9, $winners_low, $prizes, $winners, $fund );
    ...
    private function build_prize_table( $hits10, $hits9, $winners_low, $values, $winners, $fund, $editable = true ) {
        $out = '';
        if ( $editable ) {
    ...
    private function export_winners_html( $result, $contest_id, $contest_title, $order_by = 'score', $prizes = array(), $winners = array(), $fund = '' ) {
        ...
        echo $this->build_prize_table( $hits10, $hits9, $winners_low, $prizes, $winners, $fund, false );
