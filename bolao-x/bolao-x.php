...
class BOLAOX_Plugin {
    ...
    public function results_page() {
        ...
        echo '<div class="bx-info-tab"><span>' . esc_html__( 'NAVEGADOR MAIS USADO', self::TEXT_DOMAIN ) . '</span><strong>' . esc_html( $top_browser ) . '</strong></div>';
        echo '<div class="bx-info-tab"><span>' . esc_html__( 'SISTEMA OPERACIONAL MAIS USADO', self::TEXT_DOMAIN ) . '</span><strong>' . esc_html( $top_platform ) . '</strong></div>';
        echo '</div></div>';
        echo '</div>';
    }
