...
class BOLAOX_Plugin {
    ...
    public function results_page() {
        ...
        echo '<h2>' . esc_html__( 'Visao Geral', self::TEXT_DOMAIN ) . '</h2>';
        ...
        echo '<div class="bolaox-graph"><h3>' . esc_html__( 'Visitas nos ultimos 15 dias', self::TEXT_DOMAIN ) . '</h3><canvas id="bx-visits" height="100"></canvas></div>';
        echo '<div class="bolaox-graph"><h3>' . esc_html__( 'Usuarios nos ultimos 15 dias', self::TEXT_DOMAIN ) . '</h3><canvas id="bx-users" height="100"></canvas></div>';
        echo '<div class="bolaox-graph"><h3>' . esc_html__( 'Visitas por pais', self::TEXT_DOMAIN ) . '</h3><canvas id="bx-countries" height="100"></canvas></div>';
        echo '<div class="bolaox-graph"><h3>' . esc_html__( 'Plataformas usadas', self::TEXT_DOMAIN ) . '</h3><canvas id="bx-platforms" height="100"></canvas></div>';
        echo '<div class="bolaox-graph"><h3>' . esc_html__( 'Navegadores usados', self::TEXT_DOMAIN ) . '</h3><canvas id="bx-browsers" height="100"></canvas></div>';
        echo '</div></div>';
        echo '</div>';
    }
