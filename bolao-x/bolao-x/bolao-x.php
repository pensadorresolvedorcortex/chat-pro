...
class BOLAOX_Plugin {
    ...
    public function render_profile_shortcode() {
        ...
        $html .= '<p class="bolaox-field"><label>' . esc_html__( 'Nome', self::TEXT_DOMAIN ) . '<br /><input type="text" name="bolaox_first_name" value="' . esc_attr( $user->first_name ) . '" /></label></p>';
        $html .= '<p class="bolaox-field"><label>' . esc_html__( 'Sobrenome', self::TEXT_DOMAIN ) . '<br /><input type="text" name="bolaox_last_name" value="' . esc_attr( $user->last_name ) . '" /></label></p>';
        $html .= '<p class="bolaox-field"><label>' . esc_html__( 'Foto', self::TEXT_DOMAIN ) . '<br /><input type="file" name="bolaox_avatar" accept="image/*" /></label></p>';
        if ( $avatar_id ) {
        ...
        $html .= '<p class="bolaox-field"><label>' . esc_html__( 'Nova senha', self::TEXT_DOMAIN ) . '<br /><input type="password" name="bolaox_pass1" required /></label></p>';
        $html .= '<p class="bolaox-field"><label>' . esc_html__( 'Confirme a senha', self::TEXT_DOMAIN ) . '<br /><input type="password" name="bolaox_pass2" required /></label></p>';
