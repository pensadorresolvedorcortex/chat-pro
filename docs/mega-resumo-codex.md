...
- **Android toolchain**: Android SDK 36, JDK 17 e Android Gradle Plugin 8.7.3/Gradle 8.9 (automatizados pelos scripts `bootstrap_gradle_wrapper.py` e `generate_mobile_assets.py`).
