...
* Adiciona o menu "Introdução" no painel do WordPress com campos para trocar logo, textos e redirecionamento do slider onboarding.
* Reconstrói o slider onboarding com layout mobile-first em efeito glass, CTA sincronizada com o popup de login/cadastro e botões acessíveis de avançar/voltar.
