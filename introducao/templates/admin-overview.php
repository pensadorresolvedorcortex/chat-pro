            ...
            <div class="lae-admin-slides">
                <?php foreach ( $slides as $index => $slide ) :
                    ...
                    <fieldset class="lae-admin-slide">
                        ...
                        <label for="introducao-slide-image-<?php echo esc_attr( $index ); ?>" class="screen-reader-text"><?php esc_html_e( 'Imagem ilustrativa', 'introducao' ); ?></label>
                        <input
                            type="url"
                            id="introducao-slide-image-<?php echo esc_attr( $index ); ?>"
                            name="<?php echo esc_attr( Introducao_Plugin::SLIDER_OPTION ); ?>[slides][<?php echo esc_attr( $index ); ?>][image]"
                            value="<?php echo esc_attr( $image ); ?>"
                            placeholder="https://.../onboarding.png"
                            class="regular-text"
                        />
                        <p class="description"><?php esc_html_e( 'Informe uma imagem PNG/SVG com fundo transparente para ilustrar o passo.', 'introducao' ); ?></p>
                    </fieldset>
                <?php endforeach; ?>
            </div>
