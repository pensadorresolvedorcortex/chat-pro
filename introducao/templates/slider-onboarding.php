...
<section
    ...
    aria-label="<?php esc_attr_e( 'Apresentação da Academia da Comunicação', 'introducao' ); ?>"
>
                        ...
                        <div class="lae-onboarding__device">
                            <div class="lae-onboarding__device-shell">
                                <div class="lae-onboarding__device-screen">
                                    <span class="lae-onboarding__step-chip"><?php esc_html_e( 'Passo', 'introducao' ); ?> <?php echo esc_html( $index + 1 ); ?></span>
                    ...
                    <div class="lae-onboarding__text">
                        ...
                        <?php if ( $index === count( $slides ) - 1 ) : ?>
                            <div class="lae-onboarding__actions" data-lae-finish hidden>
                                ...
                                <span class="lae-onboarding__cta-hint"><?php esc_html_e( 'Escolha a melhor opção para você e continue logado em toda a plataforma.', 'introducao' ); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </article>
