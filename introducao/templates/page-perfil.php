...
>
    ...
    <div class="introducao-perfil__panels">
        ...
        <form method="post" action="<?php echo esc_url( $form_action_url ); ?>"<?php if ( ! empty( $login_errors ) ) : ?> aria-describedby="<?php echo esc_attr( $login_errors_id ); ?>"<?php endif; ?><?php if ( $is_modal_context ) : ?> data-lae-login-form="login"<?php endif; ?>>
            ...
            <?php if ( ! $login_has_otp ) : ?>
                <p<?php if ( $is_modal_context ) : ?> data-lae-login-password<?php endif; ?>>
            ...
            <?php if ( $login_has_otp ) : ?>
                <p>
                    <label for="lae-login-otp"><?php esc_html_e( 'Código de acesso', 'introducao' ); ?></label>
                    <input
                        type="text"
                        id="lae-login-otp"
                        name="lae_otp_code"
                ...
                <?php if ( ! $register_has_otp ) : ?>
                    <p>
                        ...
                        <input
                            ...
                            required
                        />
                        <small class="introducao-perfil__hint"<?php if ( $is_modal_context ) : ?> data-lae-password-strength<?php endif; ?>><?php esc_html_e( 'Use ao menos 8 caracteres com letras, números e símbolos.', 'introducao' ); ?></small>
                    </p>
                <?php endif; ?>
            </div>
