...
>
    ...
    <div class="introducao-perfil__panels">
        ...
        <form method="post" action="<?php echo esc_url( $form_action_url ); ?>"<?php if ( ! empty( $login_errors ) ) : ?> aria-describedby="<?php echo esc_attr( $login_errors_id ); ?>"<?php endif; ?>>
        ...
        <form method="post" action="<?php echo esc_url( $form_action_url ); ?>"<?php if ( ! empty( $register_errors ) ) : ?> aria-describedby="<?php echo esc_attr( $register_errors_id ); ?>"<?php endif; ?>>
            <?php wp_nonce_field( 'lae_perfil_action', 'lae_perfil_nonce' ); ?>
