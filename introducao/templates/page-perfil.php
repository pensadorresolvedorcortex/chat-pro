...
>
    <div class="introducao-perfil__switch" role="tablist" aria-label="<?php esc_attr_e( 'Escolha entre entrar ou criar uma nova conta', 'introducao' ); ?>">
        <button
            ...
            <?php if ( $is_modal_context ) : ?>data-lae-login-tab="login"<?php endif; ?>
            role="tab"
        ...
        <button
            ...
            <?php if ( $is_modal_context ) : ?>data-lae-login-tab="register"<?php endif; ?>
            role="tab"
    ...
    <div class="introducao-perfil__panels">
        ...
        <form method="post" action="<?php echo esc_url( $form_action_url ); ?>"<?php if ( ! empty( $login_errors ) ) : ?> aria-describedby="<?php echo esc_attr( $login_errors_id ); ?>"<?php endif; ?><?php if ( $is_modal_context ) : ?> data-lae-login-form="login"<?php endif; ?>>
            ...
            <p class="introducao-field">
                ...
                />
                <small class="introducao-field__hint"><?php esc_html_e( 'Digite o e-mail cadastrado ou seu usuário.', 'introducao' ); ?></small>
            </p>
            ...
            <?php if ( ! $login_has_otp ) : ?>
                <p class="introducao-field introducao-field--password"<?php if ( $is_modal_context ) : ?> data-lae-login-password<?php endif; ?>>
                    ...
                    <input
                        ...
                        required
                    />
                    <small class="introducao-field__hint"><?php esc_html_e( 'Sua senha diferencia maiúsculas e minúsculas.', 'introducao' ); ?></small>
                </p>
            <?php endif; ?>
            ...
            <?php if ( $login_has_otp ) : ?>
                <p class="introducao-field introducao-field--otp">
                    ...
                    <input
                        ...
                        required
                    />
                    <small class="introducao-field__hint"><?php esc_html_e( 'O código tem 6 dígitos e expira rapidamente por segurança.', 'introducao' ); ?></small>
                </p>
            <?php endif; ?>
        ...
        <form method="post" action="<?php echo esc_url( $form_action_url ); ?>"<?php if ( ! empty( $register_errors ) ) : ?> aria-describedby="<?php echo esc_attr( $register_errors_id ); ?>"<?php endif; ?><?php if ( $is_modal_context ) : ?> data-lae-login-form="register"<?php endif; ?>>
            ...
            <div class="introducao-perfil__fields"<?php if ( $is_modal_context ) : ?> data-lae-register-fields<?php endif; ?>>
                <p class="introducao-field">
                    ...
                    />
                    <small class="introducao-field__hint"><?php esc_html_e( 'Escolha um nome fácil de lembrar. Você poderá alterá-lo depois.', 'introducao' ); ?></small>
                </p>
                ...
                <p class="introducao-field">
                    ...
                    <input
                        ...
                        <?php echo $register_has_otp ? 'readonly' : 'required'; ?>
                    />
                    <small class="introducao-field__hint"><?php esc_html_e( 'Usaremos este e-mail para enviar o código de verificação e novidades da plataforma.', 'introducao' ); ?></small>
                </p>
                ...
                <?php if ( ! $register_has_otp ) : ?>
                    <p class="introducao-field introducao-field--password introducao-field--wide">
                        ...
                        <input
                            ...
                            required
                        />
                        <small class="introducao-field__hint"<?php if ( $is_modal_context ) : ?> data-lae-password-strength<?php endif; ?>><?php esc_html_e( 'Use ao menos 8 caracteres com letras, números e símbolos.', 'introducao' ); ?></small>
                    </p>
                <?php endif; ?>
            </div>
