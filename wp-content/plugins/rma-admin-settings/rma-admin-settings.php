...
function rma_render_verification_email_template(array $context = []): string {
    ...
    <div style="background:<?php echo esc_attr($bg); ?>;padding:30px 14px;font-family:'Segoe UI',Inter,Arial,sans-serif;">
      <div style="max-width:620px;margin:0 auto;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #e9eef3;box-shadow:0 18px 48px rgba(15,23,42,.14);">
        ...
        <div style="background:#05070b;color:#f8fafc;padding:20px 24px 22px;">
          <h3 style="margin:0 0 10px;font-size:18px;line-height:1.3;color:#ffffff;">Informações de Contato</h3>
          <p style="margin:0 0 6px;font-size:15px;line-height:1.5;">✉️ contato@rma.org.br</p>
          <p style="margin:0 0 6px;font-size:15px;line-height:1.5;">📍 Sede fiscal: Brasília DF</p>
          <p style="margin:0 0 6px;font-size:15px;line-height:1.5;">📍 Rua Amoreira, 12 - Lazaro - 11685-482 | Ubatuba - SP - Brasil</p>
          <p style="margin:0 0 6px;font-size:15px;line-height:1.5;">🎧 +55 (41) 99284-5122</p>
          <p style="margin:0;font-size:15px;line-height:1.5;">🟢 +55 (41) 99284-5122</p>
        </div>
      </div>
    </div>
    <?php
