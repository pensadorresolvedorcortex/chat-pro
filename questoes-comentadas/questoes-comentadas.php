...
class Questoes_Comentadas_Plugin {
    ...
    const OPTION_REWRITE    = 'qc_rewrite_rules_version';
    ...
    public function register_post_type_and_taxonomies() {
        ...
        register_post_type(
            ...
            [
                ...
                'has_archive'        => 'questoes-comentadas',
                'rewrite'            => [
                    'slug'       => 'questoes-comentadas',
                    'with_front' => false,
                ],
