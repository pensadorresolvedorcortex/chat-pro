...
if (!class_exists('ElfsightWhatsappChatPluginAdmin')) {
    class ElfsightWhatsappChatPluginAdmin {
        ...
        private $customScriptUrl;
        private $customStyleUrl;

        private $productUrl;
        private $productReviewUrl;
        private $productFacebookReviewUrl;
        private $helpscoutSubmitUrl;
        private $helpscoutPluginId;
        private $checkSupportExpiredUrl;
        ...
        public function registerAssets() {
            ...
            wp_register_script(
                $this->slug . '-signals',
                'https://cdn.jsdelivr.net/npm/js-signals@1.0.0/dist/signals.min.js',
                array(),
                null,
                true
            );
            wp_register_script(
                $this->slug . '-crossroads',
                'https://cdn.jsdelivr.net/npm/crossroads@0.12.2/dist/crossroads.min.js',
                array(),
                null,
                true
            );
            wp_register_script(
                $this->slug . '-jquery-tablesorter',
            ...
            wp_register_script(
                $this->slug . '-hasher',
                'https://cdnjs.cloudflare.com/ajax/libs/hasher/1.2.0/js/hasher.min.js',
                array(),
                null,
                true
            );
            ...
            wp_register_script(
                $this->slug . '-angular-slider',
                'https://cdnjs.cloudflare.com/ajax/libs/angularjs-slider/6.4.3/rzslider.min.js',
                array($this->slug . '-angular'),
                null,
                true
            );
