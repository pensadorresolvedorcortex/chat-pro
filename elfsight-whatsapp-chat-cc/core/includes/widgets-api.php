...
if (!class_exists('ElfsightWhatsappChatWidgetsApi')) {
    class ElfsightWhatsappChatWidgetsApi {
        private $slug;
        private $file;
        private $textDomain;
        ...
        public function __construct($slug, $file, $text_domain) {
            self::$ERROR_DOESNT_EXIST = esc_html__('Widget with the specified id doesn\'t exist.', $text_domain);
            ...
            self::$ERROR_SQL = esc_html__('An MySQL error occurred while adding new widget.', $text_domain);
