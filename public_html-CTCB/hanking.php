    ...
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <?php
          ...
          $contarEventos = $metodos->contarEventosAtirador($idUsuario);
        ?>
        ...
        <?php } ?>
        <div class="alert alert-warning"><i class="fas fa-exclamation-triangle"></i> Você tem acumulado nos últimos 12 meses: <?php echo $contarEventos[1]; ?> (as provas de ar comprimido não são utilizadas para habitualidade).</div>
        <?php // if($contarEventos[0] > 2){
          $data = date("Y-m-d");
          $contarFiliacao = $metodos->contarDeclaracao($tipo = 'R',$data);
          if($contarFiliacao > 0){
          ?>
          ...
          <?php } ?>
<p>Selecione abaixo a declaração desejada:</p>
<a href="!#" class="autenticacao"  data-toggle="modal" data-id="1" data-target=".bd-example-modal-lg"><i class="fas fa-caret-right"></i> Renovação de certificado de registro</a>
<br>
<a href="!#" class="autenticacao" data-toggle="modal" data-id="2" data-target=".bd-example-modal-lg"><i class="fas fa-caret-right"></i> Para fins de aquisições armas, insumos e máquina de recarga </a>
<br>
<a href="!#" class="autenticacao" data-toggle="modal" data-id="3" data-target=".bd-example-modal-lg"><i class="fas fa-caret-right"></i> Para fins de transferencias de armas e/ou maquina de recarga </a>
            <!--<div align="center"><a href="!#" class="btn btn-primary autenticacao" data-toggle="modal" data-target=".bd-example-modal-lg">Imprimir <i class="fas fa-print"></i></a></div>-->
             <br><br>
             ...
             $(document).on('click',".autenticacao", function(){
               ...
               $.post('<?php echo $caminhoAbsoluto; ?>/visualizar-hanking.php',{tipo: codigo}, function(retorno){
          ...
          <?php
            $contarFiliacao = $metodos->contarDeclaracao($tipo = 'R',$data = null);
            if($contarFiliacao > 0){ ?>
           Confira abaixo as declarações já emitidas:
             <?php
             echo $metodos->visualizarDeclaracoes($tipo = 'R');
              }
            //}
          ?>
      </div>
