...
if($_REQUEST["tipo"] == '1')
{
  $tipoImpressao = 'revalidação de Certificado de Registro';
}
if($_REQUEST["tipo"] == '2')
{
  $tipoImpressao = 'aquisições de armas, insumos e máquina de recarga';
}
if($_REQUEST["tipo"] == '3')
{
    $tipoImpressao = 'transferencias de armas e/ou maquina de recarga';
}
?>
<!DOCTYPE html>
...
<!-- CORPO -->
<tr>
  <td width="100%" height="40" colspan="3" align="center" valign="middle" style="font-size: 18px; font-weight: bold">DECLARAÇÃO DE RANKING</td>
</tr>
<tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3">
          ...
          ?>
          <div align="justify"><p style="line-height: 200%; padding: 0, 20px; font-size: 23px">
          ...
          para fins de <?php echo $tipoImpressao; ?>. que <b><?php echo $visualizar[1]->nome; ?></b>, CR nº <b><?php echo $visualizar[1]->cr ?></b>, está regularmente inscrito nesta entidade
