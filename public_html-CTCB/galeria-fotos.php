...
if($visualizar[0] == 0)
{
  echo "<script>window.location.href='".$caminhoAbsoluto."/galeria/'</script>";
  exit();
}
?>
<!DOCTYPE html>
     ...
     <div class="collapse navbar-collapse menu-inferior-info mobile-duno" id="navbarNav">
       <ul class="navbar-nav">
         ...
         <li class="nav-item active">
           <a class="nav-link active" href="<?php echo $caminhoAbsoluto; ?>/fotos/"  alt="Ir para a página de fotos">Fotos</a>
         </li>
         <span class="linha-vertical"></span>
         <li class="nav-item">
  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-12 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold">FOTOS</h3>
           <div style="margin-top: 20px">
           <div class="text-right"><button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo $caminhoAbsoluto; ?>/fotos/'">Voltar</button></div>
            <?php
               echo $metodos->mostrarFotos($visualizar[1]->galeria);
            ?>
        </div>
      </div>
