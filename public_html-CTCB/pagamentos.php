  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold"><i class="fas fa-dollar-sign"></i> PAGAMENTOS</h3>
        <div class="table-responsive" style="margin-top: 20px; text-align: center">
             <table class="table table-striped table-bordered">
                 <thead>
                   <tr>
                     <th scope="col" style="background-color: #4682B4; color: #FFF">Ano</th>
                     <th scope="col" style="background-color: #4682B4; color: #FFF">Vencimento</th>
                     <th scope="col" style="background-color: #4682B4; color: #FFF">Valor</th>
                     <th scope="col" style="background-color: #4682B4; color: #FFF">Status</th>
                   </tr>
                 </thead>
                 <tbody>
        <?php echo $metodos->visualizarPagamentosAtiradores($_SESSION["IdUsuario"]); ?>
                </tbody>
              </table>
        </div>      
      </div>
