                  ...
                  <div class="form-group">
                   ...
                   <div class="input-group">
                     <select name="Atirador" class="form-control">
                       ...
                       <?php echo $metodos->listarAtiradoresDespachantes($_SESSION["IdDespachante"]); ?>
                     </select>
