  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #DC143C; color: #FFF">
        <h5 class="modal-title" id="exampleModalLabel"><i class="far fa-trash-alt"></i> Excluir arma</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Você tem certeza que deseja excluir a arma <strong><?php echo $visualizar[1]->numero_serie; ?></strong>?
      </div>
