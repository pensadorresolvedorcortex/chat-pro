  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold"><i class="fas fa-envelope"></i> INSTRUÇÕES ENVIADAS</h3>
         <div class="alert alert-success"><i class="fas fa-check"></i> As instruções de recuperação foram enviadas com sucesso para o seu e-mail. Sugerimos verificar na caixa de Spam ou Lixo Eletrônico!</div>
      </div>
