...
<!-- CORPO -->
<tr>
  <td width="100%" height="40" colspan="3" align="center" valign="middle" style="font-size: 18px; font-weight: bold">DECLARAÇÃO DE HABITUALIDADE</td>
</tr>
<tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3">
          ...
          aquisição de munição/insumos pleiteada/pleiteados.
          <p></p>
          Esta Confederação de Tiro e Caça do Brasil dispõe dos registros que comprovam a habitualidade do referido atirador desportivo, no que diz respeito ao consumo
          de munição/insumos compatível com a atual solicitação.
          <p></p>
      ...
      <tr>
        <td align="center" colspan="3"><small>Fernando Humberto H. Fernandes<br>Presidente</small></td>
      </tr>
      <tr>
