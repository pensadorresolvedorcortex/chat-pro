    ...
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        ...
        <div class="alert alert-warning">
          <p><i class="fas fa-exclamation-triangle"></i>Atenção!!! </p>
          <p>A declaração de habitualidade está sendo atualizada para o novo modelo, atendendo ao novo Decreto. Em breve estará disponível.</p>
          <p>Informativo: Devido ao sistema ainda não ter sido adequado ao novo decreto, algumas declarações foram emitidas equivocadamente. Não sendo válidas, pois o atirador não pode comprovar habitualidade de 12 meses e participação em duas provas.</p>
          <p>21/08/2023.</p>
          <p>Atenciosamente,</p>
          <p>CTCB.</p>
        </div>
      ...
      <div class="col-md-4 col-xs-12">
       ...
       <?php include("menu-logado.php"); ?>
        ...
        <div class="row" style="padding: 10px">
          <button class="btn btn-danger" style="width: 100%; font-weight: bold" onclick="window.location.href='<?php echo $caminhoAbsoluto; ?>/validar-documentos/'"><i class="fas fa-check"></i> Validar Documentos</button></div>
        <div class="row" style="padding: 10px">
