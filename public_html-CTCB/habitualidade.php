  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold">DECLARAÇÃO HABITUALIDADE</h3>
        <h4> <div class="alert alert-warning" align="justify"><i class="fas fa-exclamation-triangle"></i> A declaração de habitualidade será impressa conforme informações inseridas pelo seu Clube neste banco de dados.</div></h4>
        ...
        <?php
        $data = date("Y-m-d");
        $contarFiliacao = $metodos->contarDeclaracao($tipo = 'H', $data);
        if($contarFiliacao > 0){
        ?>
      ...
      <?php } ?>
        <p>Confira abaixo as declarações já emitidas:</p>
         ...
         echo $metodos->visualizarDeclaracoes($tipo = 'H');
         ?>
         <!--ALTEREI O CÓDIGO AQUI PARA TESTAR-->
         ...
         $(document).on('click',".autenticacao", function(){
           ...
           $.post('<?php echo $caminhoAbsoluto; ?>/visualizar-habitualidade.php',{key: codigo}, function(retorno){
