  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold"><i class="fas fa-crosshairs"></i> ARMAS</h3><br>
        <?php if($_SESSION["Sucesso"]){ ?>
        <div class="alert alert-success">
           <i class="fas fa-check"></i> Arma cadastrada com sucesso
        </div>
        <?php } ?>
        <div class="text-right"><button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo $caminhoAbsoluto; ?>/cadastrar-armas/'"><i class="fas fa-plus-square"></i> Incluir arma</button></div>
        <div style="margin-top: 10px">
         <?php
             echo $metodos->listarArmas();
           ?>
         </div>
      </div>
