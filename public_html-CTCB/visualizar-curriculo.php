...
<html lang="pt-br" dir="ltr">
  ...
  <body>
    ...
    <div class="modal-header bg-primary text-white">
      <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold"><i class="fas fa-address-card"></i> CURRÍCULO IMPRIMIR</h5>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" onClick="window.open('<?php echo $caminhoAbsoluto; ?>/curriculo-imprimir/?datainicio=<?php echo $_REQUEST["datainicio"]; ?>&datafinal=<?php echo $_REQUEST["datafinal"]; ?>&key=<?php echo $id; ?>', '_blank', ''); window.close();" ><i class="fas fa-print"></i> Imprimir</button>
</div>
</div>
