  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold"><i class="fas fa-key"></i> ALTERAR SENHA</h3>
        <?php if($_SESSION["Sucesso"]){ ?>
            <div class="alert alert-success"><i class="fas fa-check"></i> Senha alterada com sucesso!</div>
        <?php } ?>
        <?php if($_SESSION["Erro"]){ ?>
            <div class="alert alert-danger"><i class="fas fa-check"></i> <i class="fas fa-exclamation-triangle"></i> Nenhum dado foi alterado.</div>
        <?php } ?>
        <form method="post" action="#!" style="margin-top: 30px">
           <h5 style="font-weight: bold">Nova senha:</h5>
           <div class="input-group">
                 <input type="password" name="NovaSenha" class="form-control senha-segura" id="senha" placeholder="Entre 6 a 12 caracteres" minlength="6" maxlength="12" required>
