...
class Unzipper {
  ...
  public static function extractRarArchive($archive, $destination) {
    ...
    if (!class_exists('RarArchive')) {
      $GLOBALS['status'] = array('error' => 'Error: Your PHP version does not support .rar archive functionality. <a class="info" href="https://php.net/manual/en/rar.installation.php" target="_blank">How to install RarArchive</a>');
      return;
    }
    // Check if archive is readable.
 ...
 * Class Zipper
 *
 * Copied and slightly modified from https://at2.php.net/manual/en/class.ziparchive.php#110719
