  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold">DECLARAÇÃO PARA SOLICITAR GUIA DE TRÁFEGO</h3>
        <?php
        $data = date("Y-m-d");
        $contarFiliacao = $metodos->contarDeclaracao($tipo = 'G', $data);
        if($contarFiliacao > 0){
        ?>
      ...
      <?php } ?>
        <p>Confira abaixo as declarações já emitidas:</p>
         ...
         echo $metodos->visualizarDeclaracoes($tipo = 'G');
         ?>
         ...
         $(document).on('click',".autenticacao", function(){
           ...
           $.post('<?php echo $caminhoAbsoluto; ?>/visualizar-guias.php',{key: codigo}, function(retorno){
