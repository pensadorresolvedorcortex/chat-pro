  ...
  <div style="height: 200px; background-color: #F8F8F8; background-image: linear-gradient(#F8F8F8, #FFF);">
    <div class="row" style="margin-top: 10px; padding: 10px">
      <div class="col-md-8 col-xs-12">
        <h3 style="color: #3e4095; font-weight: bold">DECLARAÇÃO DE MODALIDADE E PROVA</h3>
        <?php
        $data = date("Y-m-d");
        $contarFiliacao = $metodos->contarDeclaracao($tipo = 'M', $data);
        if($contarFiliacao > 0){
        ?>
      ...
      <?php } ?>
        <p>DECLARAÇÃO DE FILIAÇÃO A ENTIDADE</p>
         <?php
         //echo $metodos->habitualidade();
         echo $metodos->visualizarDeclaracoes($tipo = 'M');
         ?>
         ...
         $(document).on('click',".autenticacao", function(){
           ...
           $.post('<?php echo $caminhoAbsoluto; ?>/visualizar-modalidades.php',{key: codigo}, function(retorno){
