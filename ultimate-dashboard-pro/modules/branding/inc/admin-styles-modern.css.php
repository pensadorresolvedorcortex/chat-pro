...
@media screen and (min-width:961px) {
	...
	#adminmenu #collapse-menu {
		border-top: 2px solid <?php echo esc_attr( $admin_bar_bg_color ); ?>;
		margin-top: 10px;
		padding-top: 10px;
	}
...
@media screen and (max-width:960px) {
       ...
       /* Show custom admin logo on mobile */
       .wp-admin.folded #adminmenu .udb-admin-logo-wrapper {
               display: block;
               position: relative;
       }

       .wp-admin.folded #adminmenu .udb-admin-logo-wrapper a {
               position: absolute;
               top: 0;
               left: 0;
               width: 48px;
       ...
       .wp-admin.folded #adminmenu .udb-admin-logo-wrapper .udb-admin-logo {
               max-height: 100%;
               max-width: 100%;
               height: auto;
               width: auto;
...
@media screen and (min-width: 961px) {
	.wp-admin:not(.folded) #adminmenuwrap.udb-remove-padding {
		padding-top: 0;
	}

	.wp-admin:not(.folded) #adminmenuwrap.udb-use-padding {
		padding-top: 50px;
	}
}
