...
$submit_link_format = '<div class="rh_menu__user_submit"><a class="rh-btn rh-btn-primary %s" href="%s">%s</a><button type="button" class="rh-search-toggle"><i class="fa fa-search"></i></button></div>';
