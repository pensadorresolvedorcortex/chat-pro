...
document.getElementById('load-list').addEventListener('click', () => createPlayerRows(initialPlayers));

// Preenche os jogadores assim que o DOM estiver pronto
document.addEventListener('DOMContentLoaded', () => createPlayerRows(initialPlayers));
