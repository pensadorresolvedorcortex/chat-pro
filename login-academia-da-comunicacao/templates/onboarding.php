...
$login_url        = apply_filters( 'adc_login_onboarding_login_url', get_onboarding_login_url() );
$signup_url       = apply_filters( 'adc_login_onboarding_signup_url', get_onboarding_signup_url() );
$has_login_custom = '' !== get_option_value( 'onboarding_login_url', '' );
$has_signup_custom = '' !== get_option_value( 'onboarding_signup_url', '' );
?>
            ...
            <div class="adc-carousel" data-slide-count="<?php echo esc_attr( count( $slides ) ); ?>">
                ...
                <div class="adc-carousel-footer">
                    ...
                    <div class="adc-onboarding-cta">
                        <a class="adc-link"<?php echo $has_login_custom ? '' : ' data-modal-trigger="login"'; ?> href="<?php echo esc_url( $login_url ); ?>"><?php echo esc_html( $login_link_label ); ?></a>
                        <span aria-hidden="true">•</span>
                        <a class="adc-link"<?php echo $has_signup_custom ? '' : ' data-modal-trigger="signup"'; ?> href="<?php echo esc_url( $signup_url ); ?>"><?php echo esc_html( $signup_link_label ); ?></a>
                    </div>
                </div>
            </div>
        </div>
