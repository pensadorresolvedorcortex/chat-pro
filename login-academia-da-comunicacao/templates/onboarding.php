...
$login_link_label  = apply_filters( 'adc_login_onboarding_login_link_label', __( 'Já tem conta? Faça login', 'login-academia-da-comunicacao' ) );
$signup_link_label = apply_filters( 'adc_login_onboarding_signup_link_label', __( 'Nova por aqui? Crie sua conta', 'login-academia-da-comunicacao' ) );
        ...
        <div class="adc-onboarding">
            ...
            <div class="adc-carousel" data-slide-count="<?php echo esc_attr( count( $slides ) ); ?>">
                <header class="adc-carousel-header">
                    ...
                    <button class="adc-skip" data-target="<?php echo esc_url( $skip_url ); ?>"><?php echo esc_html( $skip_label ); ?></button>
                </header>
                ...
                <div class="adc-carousel-footer">
                    ...
                    <div class="adc-onboarding-cta">
                        <a class="adc-link" href="<?php echo esc_url( add_query_arg( 'step', 'login', get_onboarding_url() ) ); ?>"><?php echo esc_html( $login_link_label ); ?></a>
                        <span aria-hidden="true">•</span>
                        <a class="adc-link" href="<?php echo esc_url( add_query_arg( 'step', 'signup', get_onboarding_url() ) ); ?>"><?php echo esc_html( $signup_link_label ); ?></a>
                    </div>
                </div>
            </div>
        </div>
