...
use function ADC\Login\get_onboarding_login_step_url;
use function ADC\Login\get_onboarding_login_url;
use function ADC\Login\get_onboarding_signup_step_url;
...
$cta_url          = apply_filters( 'adc_login_onboarding_cta_url', get_onboarding_start_url() );
$skip_url         = apply_filters( 'adc_login_onboarding_skip_url', get_onboarding_skip_url() );
$login_redirect   = apply_filters( 'adc_login_onboarding_login_url', get_onboarding_login_url() );
$signup_redirect  = apply_filters( 'adc_login_onboarding_signup_url', get_onboarding_signup_url() );
$login_link       = get_onboarding_login_step_url();
$signup_link      = get_onboarding_signup_step_url();
?>
            ...
            <div class="adc-carousel" data-slide-count="<?php echo esc_attr( count( $slides ) ); ?>">
                ...
                <div class="adc-carousel-footer">
                    ...
                    <div class="adc-onboarding-cta">
                        <a class="adc-link" data-modal-trigger="login" href="<?php echo esc_url( $login_link ); ?>" data-redirect="<?php echo esc_url( $login_redirect ); ?>"><?php echo esc_html( $login_link_label ); ?></a>
                        <span aria-hidden="true">•</span>
                        <a class="adc-link" data-modal-trigger="signup" href="<?php echo esc_url( $signup_link ); ?>" data-redirect="<?php echo esc_url( $signup_redirect ); ?>"><?php echo esc_html( $signup_link_label ); ?></a>
                    </div>
                </div>
            </div>
        </div>
