(function ($) {
    ...
    $(document).on('change', '.adc-import-file-input', function (event) {
        var $input = $(event.currentTarget);
        var $control = $input.closest('.adc-import-control');
        var $label = $control.find('.adc-import-filename');
        var placeholder = $label.data('placeholder') || '';
        var fileName = '';
        ...
        $label.text(fileName || placeholder);
    });
})(jQuery);
