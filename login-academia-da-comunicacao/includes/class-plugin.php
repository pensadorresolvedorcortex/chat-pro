...
class Plugin {
    ...
    /**
     * Allow friendly admin URLs (e.g. /wp-admin/adc-login-hub) to resolve correctly.
     */
    ...
    protected function get_pretty_admin_redirects() {
        $redirects = array(
            'adc-login-hub'       => 'admin.php?page=adc-login-hub',
            'adc-login-dashboard' => 'admin.php?page=adc-login-dashboard',
        );
    ...
    public function register_admin_assets() {
        ...
        $allowed_ids = array(
            'settings_page_adc-login-hub',
            'login-academia-da-comunicacao_page_adc-login-hub',
        );
