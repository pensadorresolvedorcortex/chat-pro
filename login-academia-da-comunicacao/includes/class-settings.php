...
class Settings {
    ...
    public function register_settings() {
        ...
        add_settings_field(
            'post_login_redirect',
            __( 'URL pós-login', 'login-academia-da-comunicacao' ),
            array( $this, 'field_text' ),
            'adc-login-settings',
            'adc_login_general',
            array( 'key' => 'post_login_redirect', 'type' => 'url' )
        );
        ...
        add_settings_field(
            'onboarding_skip_url',
            __( 'URL ao pular onboarding', 'login-academia-da-comunicacao' ),
            array( $this, 'field_text' ),
            'adc-login-settings',
            'adc_login_general',
            array( 'key' => 'onboarding_skip_url', 'type' => 'url' )
        );
    ...
    public function render_page() {
        ...
        ?>
        <div class="wrap adc-login-settings">
            ...
            <form method="post" action="options.php">
                ...
                do_settings_sections( 'adc-login-settings' );
                submit_button();
                ?>
            </form>
        </div>
