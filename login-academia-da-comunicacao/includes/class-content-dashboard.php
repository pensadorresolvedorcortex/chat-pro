            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="adc-dashboard-form">
                ...
                <section class="adc-dashboard-section">
                    ...
                    <div class="adc-field-grid">
                        ...
                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Link do atalho “Entrar”', 'login-academia-da-comunicacao' ); ?></span>
                            ...
                            <span class="description"><?php esc_html_e( 'Informe a URL para quem seleciona o acesso existente.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>

                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Link do atalho “Cadastre-se”', 'login-academia-da-comunicacao' ); ?></span>
                            ...
                            <span class="description"><?php esc_html_e( 'Defina o endereço da tela de criação de conta.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>
                    </div>
                </section>
