...
use function ADC\Login\get_onboarding_login_url;
use function ADC\Login\get_onboarding_signup_url;
use function ADC\Login\get_onboarding_skip_url;
use function ADC\Login\get_onboarding_start_url;
...
class Content_Dashboard {
    ...
    /**
     * Menu slug used across the dashboard screens.
     */
    const MENU_SLUG = 'adc-login-manager';
    ...
    public function handle_save() {
        ...
        $options_payload = isset( $_POST['adc_options'] ) ? wp_unslash( $_POST['adc_options'] ) : array(); // phpcs:ignore WordPress.Security.NonceVerification
        ...
        if ( is_array( $options_payload ) ) {
            ...
            foreach ( $link_keys as $key ) {
                $value = isset( $options_payload[ $key ] ) ? trim( $options_payload[ $key ] ) : '';

                $options[ $key ] = '' !== $value ? esc_url_raw( $value ) : '';
            }
    ...
    public function render_page() {
        ...
        $link_values = array(
            'onboarding_skip_url'   => get_option_value( 'onboarding_skip_url' ),
            'onboarding_start_url'  => get_option_value( 'onboarding_start_url' ),
            'onboarding_login_url'  => get_option_value( 'onboarding_login_url' ),
            'onboarding_signup_url' => get_option_value( 'onboarding_signup_url' ),
        );

        $link_fallbacks = array(
            'onboarding_skip_url'   => get_onboarding_skip_url(),
            'onboarding_start_url'  => get_onboarding_start_url(),
            'onboarding_login_url'  => get_onboarding_login_url(),
            'onboarding_signup_url' => get_onboarding_signup_url(),
        );
        ...
        <div class="wrap adc-dashboard">
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="adc-dashboard-form">
                ...
                <section class="adc-dashboard-section">
                    <header>
                        <h2><?php esc_html_e( 'Links dos botões do app', 'login-academia-da-comunicacao' ); ?></h2>
                        <p><?php esc_html_e( 'Defina para onde cada ação do onboarding deve direcionar os usuários.', 'login-academia-da-comunicacao' ); ?></p>
                    </header>

                    <div class="adc-field-grid">
                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Destino do botão “Pular”', 'login-academia-da-comunicacao' ); ?></span>
                            <input type="url" name="adc_options[onboarding_skip_url]" value="<?php echo esc_attr( $link_values['onboarding_skip_url'] ); ?>" placeholder="<?php echo esc_attr( $link_fallbacks['onboarding_skip_url'] ); ?>" />
                            <span class="description"><?php esc_html_e( 'Deixe em branco para usar o caminho padrão da home.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>

                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Destino do botão “Iniciar”', 'login-academia-da-comunicacao' ); ?></span>
                            <input type="url" name="adc_options[onboarding_start_url]" value="<?php echo esc_attr( $link_values['onboarding_start_url'] ); ?>" placeholder="<?php echo esc_attr( $link_fallbacks['onboarding_start_url'] ); ?>" />
                            <span class="description"><?php esc_html_e( 'Deixe em branco para abrir o fluxo de login padrão.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>

                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Redirecionamento após “Entrar”', 'login-academia-da-comunicacao' ); ?></span>
                            <input type="url" name="adc_options[onboarding_login_url]" value="<?php echo esc_attr( $link_values['onboarding_login_url'] ); ?>" placeholder="<?php echo esc_attr( $link_fallbacks['onboarding_login_url'] ); ?>" />
                            <span class="description"><?php esc_html_e( 'Deixe vazio para levar o usuário à home padrão depois do login.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>

                        <label class="adc-field">
                            <span class="adc-field-label"><?php esc_html_e( 'Redirecionamento após “Cadastre-se”', 'login-academia-da-comunicacao' ); ?></span>
                            <input type="url" name="adc_options[onboarding_signup_url]" value="<?php echo esc_attr( $link_values['onboarding_signup_url'] ); ?>" placeholder="<?php echo esc_attr( $link_fallbacks['onboarding_signup_url'] ); ?>" />
                            <span class="description"><?php esc_html_e( 'Use esta URL para onde novos cadastros devem chegar automaticamente.', 'login-academia-da-comunicacao' ); ?></span>
                        </label>
                    </div>
                </section>
    ...
    public function enqueue_assets( $hook ) {
        $valid_hooks = array(
            ...
            'login-academia-da-comunicacao_page_' . self::MENU_SLUG,
        );
