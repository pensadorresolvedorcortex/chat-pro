(function () {
    ...
    var initLoginModal = function () {
        ...
        if (loginElements.forms.login) {
            ...
            if (!loginElements.loginPasswordWrap && loginPasswordInput && typeof loginPasswordInput.closest === 'function') {
                loginElements.loginPasswordWrap = loginPasswordInput.closest('p');
            }
