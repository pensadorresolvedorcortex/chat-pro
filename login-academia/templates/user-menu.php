...
<?php if ( ! is_user_logged_in() ) :
    ...
    ?>
    <div class="lae-login-modal" data-lae-login-modal aria-hidden="true">
                    ...
                    <div class="lae-login-forms">
                        <form id="<?php echo esc_attr( $login_form_id ); ?>" class="lae-login-form is-active" data-lae-login-form="login">
                            <div class="lae-login-field">
                                ...
                                <input type="text" id="<?php echo esc_attr( $login_form_id ); ?>-user" name="login" autocomplete="username" required />
                            </div>
                            <div class="lae-login-field" data-lae-login-password data-lae-password-field>
                                <label for="<?php echo esc_attr( $login_form_id ); ?>-pass"><?php esc_html_e( 'Senha', 'login-academia-da-educacao' ); ?></label>
                                <input type="password" id="<?php echo esc_attr( $login_form_id ); ?>-pass" name="password" autocomplete="current-password" required />
                            ...
                            <div class="lae-login-two-factor" data-lae-login-2fa hidden>
                        ...
                        <form id="<?php echo esc_attr( $register_form_id ); ?>" class="lae-login-form" data-lae-login-form="register" hidden>
                            <div class="lae-register-fields" data-lae-register-fields>
                                <div class="lae-login-field">
                                    <label for="<?php echo esc_attr( $register_form_id ); ?>-name"><?php esc_html_e( 'Nome completo', 'login-academia-da-educacao' ); ?></label>
                                    <input type="text" id="<?php echo esc_attr( $register_form_id ); ?>-name" name="name" autocomplete="name" required />
                                </div>
                                <div class="lae-login-field">
                                    <label for="<?php echo esc_attr( $register_form_id ); ?>-email"><?php esc_html_e( 'Email', 'login-academia-da-educacao' ); ?></label>
                                    <input type="email" id="<?php echo esc_attr( $register_form_id ); ?>-email" name="email" autocomplete="email" required />
                                </div>
                                <div class="lae-login-field" data-lae-password-field>
                                    ...
                                    <input type="password" id="<?php echo esc_attr( $register_form_id ); ?>-pass" name="password" autocomplete="new-password" required />
                                    <button type="button" class="lae-password-toggle" data-lae-password-toggle aria-pressed="false">
                                        <span data-lae-password-toggle-label><?php esc_html_e( 'Mostrar', 'login-academia-da-educacao' ); ?></span>
                                    </button>
                                ...
                                <div class="lae-login-field" data-lae-password-field>
                                    ...
                                    <input type="password" id="<?php echo esc_attr( $register_form_id ); ?>-confirm" name="confirm" autocomplete="new-password" required />
                                    <button type="button" class="lae-password-toggle" data-lae-password-toggle aria-pressed="false">
                                        <span data-lae-password-toggle-label><?php esc_html_e( 'Mostrar', 'login-academia-da-educacao' ); ?></span>
                                    </button>
                            ...
                            <div class="lae-login-two-factor" data-lae-register-2fa hidden>
