...
<div class="lae-user-menu-shell">
    <nav
        class="lae-user-menu"
        data-lae-menu
        data-lae-logged="<?php echo $is_logged_in ? '1' : '0'; ?>"
        data-lae-has-modal="<?php echo ( $modal_enabled && $introducao_modal_markup ) ? '1' : '0'; ?>"
        data-lae-original-modal="<?php echo ( $modal_enabled && $introducao_modal_markup ) ? '1' : '0'; ?>"
        id="<?php echo esc_attr( $menu_id ); ?>"
        aria-label="<?php esc_attr_e( 'Menu do usuário', 'login-academia-da-educacao' ); ?>"
    >
        ...
        <div class="lae-user-dropdown">
            ...
            <div class="lae-dropdown-menu" data-lae-dropdown id="<?php echo esc_attr( $dropdown_id ); ?>" aria-hidden="true">
