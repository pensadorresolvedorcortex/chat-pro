...
$default_slides = array(
    array(
        ...
        'description' => __( 'Visualize cronogramas, lembretes e metas inteligentes em um painel pronto para desktop.', 'login-academia-da-educacao' ),
        'art'         => 'journey',
    ),
    array(
        'title'       => __( 'Treine com apoio personalizado', 'login-academia-da-educacao' ),
        'description' => __( 'Combine simulados, aulas ao vivo e feedback imediato para manter sua evolução constante.', 'login-academia-da-educacao' ),
        'art'         => 'focus',
    ),
    array(
        'title'       => __( 'Conecte-se à comunidade certa', 'login-academia-da-educacao' ),
        'description' => __( 'Entre ou crie sua conta e compartilhe jornadas com colegas, mentores e especialistas.', 'login-academia-da-educacao' ),
        'art'         => 'community',
    ),
);
...
$slider_id = $generate_id( 'lae-onboarding-desktop-' );
    ...
    <div class="lae-onboarding__surface">
        <header class="lae-onboarding__header">
            ...
            <?php if ( $total_slides > 1 ) : ?>
                <button type="button" class="lae-onboarding__skip" data-lae-skip data-lae-target="<?php echo esc_attr( $total_slides - 1 ); ?>">
                    <?php esc_html_e( 'Pular apresentação', 'login-academia-da-educacao' ); ?>
                </button>
            <?php endif; ?>
        </header>
            ...
            <?php foreach ( $slides as $index => $slide ) :
                ...
                >
                    <div class="lae-onboarding__media" aria-hidden="true">
                        <span class="lae-onboarding__art lae-onboarding__art--<?php echo esc_attr( $art_preset ); ?>"></span>
                    </div>
                    ...
                    <div class="lae-onboarding__body">
                        ...
                        <?php if ( $index === $total_slides - 1 ) : ?>
                            <div class="lae-onboarding__finish" data-lae-finish hidden aria-hidden="true">
                                ...
                                <p class="lae-onboarding__hint"><?php esc_html_e( 'Ao concluir, você seguirá logado para explorar o painel completo.', 'login-academia-da-educacao' ); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </article>
        ...
        <footer class="lae-onboarding__footer">
            <button
                ...
                data-lae-prev
                aria-label="<?php esc_attr_e( 'Etapa anterior', 'login-academia-da-educacao' ); ?>"
                disabled
                aria-disabled="true"
            >
            ...
            <div class="lae-onboarding__dots" role="tablist" aria-label="<?php esc_attr_e( 'Controle de etapas', 'login-academia-da-educacao' ); ?>">
                <?php foreach ( $slides as $index => $slide ) :
                    $control_id = $slider_id . '-step-' . $index;
                    $panel_id   = $slider_id . '-step-' . $index . '-panel';
                    $is_active  = 0 === $index;
            ...
            <button
                ...
                data-lae-next
                aria-label="<?php esc_attr_e( 'Próxima etapa', 'login-academia-da-educacao' ); ?>"
            >
