                        ...
                        <?php if ( $index === $total_slides - 1 ) : ?>
                            <div class="lae-onboarding__finish" data-lae-finish hidden aria-hidden="true">
                                <div class="lae-onboarding__cta-group">
                                    <button type="button" class="lae-onboarding__cta" data-lae-login-trigger data-lae-login-mode="login">
                                        <?php esc_html_e( 'Entrar', 'login-academia-da-educacao' ); ?>
                                    </button>
                                    <button type="button" class="lae-onboarding__cta lae-onboarding__cta--ghost" data-lae-login-trigger data-lae-login-mode="register">
