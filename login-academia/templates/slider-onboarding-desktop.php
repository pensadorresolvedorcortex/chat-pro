...
$default_slides  = $plugin_instance ? $plugin_instance->get_default_slider_texts() : array(
    array(
        'title'       => __( 'Domine sua jornada', 'login-academia-da-educacao' ),
        'description' => __( 'Transforme teoria, prática e simulados em um ciclo inteligente que acelera sua aprovação.', 'login-academia-da-educacao' ),
    ),
    array(
        'title'       => __( 'Conecte-se com insights', 'login-academia-da-educacao' ),
        'description' => __( 'Acompanhe métricas em tempo real, receba alertas personalizados e ajuste o ritmo com segurança.', 'login-academia-da-educacao' ),
    ),
    array(
        'title'       => __( 'Comece agora mesmo', 'login-academia-da-educacao' ),
        'description' => __( 'Crie sua conta ou faça login e ative a experiência completa da Academia da Comunicação.', 'login-academia-da-educacao' ),
    ),
);
...
?>
<section class="lae-onboarding lae-onboarding--desktop" data-lae-slider aria-label="<?php esc_attr_e( 'Apresentação interativa da Academia da Comunicação', 'login-academia-da-educacao' ); ?>">
    <div class="lae-onboarding__layout">
        <aside class="lae-onboarding__sidebar" aria-hidden="false">
            ...
            <?php endif; ?>
            <p class="lae-onboarding__tagline"><?php esc_html_e( 'Sua central de estudos conectada', 'login-academia-da-educacao' ); ?></p>
            <div class="lae-onboarding__progress" role="tablist" aria-label="<?php esc_attr_e( 'Etapas de apresentação', 'login-academia-da-educacao' ); ?>">
        ...
        <div class="lae-onboarding__main">
            <header class="lae-onboarding__header">
                <span class="lae-onboarding__eyebrow"><?php esc_html_e( 'Bem-vindo à Academia da Comunicação', 'login-academia-da-educacao' ); ?></span>
                <h1 class="lae-onboarding__hero-title"><?php esc_html_e( 'Uma experiência imersiva para acelerar seus resultados', 'login-academia-da-educacao' ); ?></h1>
            </header>
                    ...
                    >
                        ...
                        <?php if ( $index === count( $slides ) - 1 ) : ?>
                            <div class="lae-onboarding__actions" data-lae-finish hidden>
                                ...
                                <span class="lae-onboarding__cta-hint"><?php esc_html_e( 'Escolha como acessar e continue sua jornada sem sair do fluxo.', 'login-academia-da-educacao' ); ?></span>
                            </div>
                        <?php endif; ?>
                    </article>
                <?php endforeach; ?>
