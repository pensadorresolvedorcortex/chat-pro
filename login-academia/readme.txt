...
= 1.8.1 =
* Mantém o dropdown do shortcode `[lae_user_menu]` acessível para todos os visitantes e aciona o modal de login apenas ao clicar em **Entrar**, evitando travamentos ao abrir o menu.
* Reutiliza integralmente o layout do shortcode `[introducao_perfil]` dentro do modal, corrigindo contrastes, alinhamentos e responsividade no desktop e mobile.
* Embute o slider onboarding mobile-first com o mesmo popup sincronizado e redirecionamento configurável definido no plugin Introdução.
