    ...
    <div class="juntaplay-header__inner">
        <?php if ($header_guest) : ?>
            <div class="juntaplay-header__guest">
                ...
                <?php if ($header_guest && $header_auth_modal) : ?>
                    ...
                    <template id="jp-auth-modal-template" data-auto-open="<?php echo esc_attr($header_auth_auto_open); ?>">
                        <?php
                        $login_errors    = isset($header_auth_context['login_errors']) && is_array($header_auth_context['login_errors']) ? $header_auth_context['login_errors'] : [];
                        $register_errors = isset($header_auth_context['register_errors']) && is_array($header_auth_context['register_errors']) ? $header_auth_context['register_errors'] : [];
                        $active_view     = isset($header_auth_context['active_view']) ? (string) $header_auth_context['active_view'] : 'login';
                        $redirect_to     = isset($header_auth_context['redirect_to']) ? (string) $header_auth_context['redirect_to'] : '';
