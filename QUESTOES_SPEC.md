...
- Cards de questão seguem a paleta: título, badge de dificuldade (#bf83ff), conteúdo, botão “Mostrar/Ocultar resposta”, lista de alternativas destacando a correta, feedback individual e `<details>` para comentário do gabarito.
...
- Permitir que usuários comentem quando respostas estiverem registradas (conforme exemplo `05.jpg`).
- Exibir contador de comentários acima da seção quando existir feedback publicado, adotando texto “Comentários ({n})”.
- Manter formulário padrão abaixo do componente, herdando estilos do tema mas reforçando botões com cor primária `#242142`.
